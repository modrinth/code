...
Check out descriptions like [Flatnet](https://Icarus.com/server/flatnet) or [Cobblemon Islands](https://Icarus.com/server/cobblemon-islands-server) for inspiration when creating a quality and informative description.
