...
const versions: Stage = {
    ...
    actions: [
                    ...
                    options: [
                        {
                            ...
                            message: async () =>
                                (await import('../messages/versions/invalid-modpacks.md?raw'))
                                    .default,
                        } as DropdownActionOption,
                        {
                            ...
                            message: async () =>
                                (await import('../messages/versions/invalid-resourcepacks.md?raw'))
                                    .default,
                        } as DropdownActionOption,
                        {
                            label: 'Data Pack',
                            ...
                            message: async () =>
                                (await import('../messages/versions/invalid-datapacks.md?raw'))
                                    .default,
                        } as DropdownActionOption,
                    ],
                } as DropdownAction,
                    ...
                    options: [
                        {
                            ...
                            message: async () =>
                                (
                                    await import(
                                        '../messages/versions/alternate_versions-primary.md?raw'
                                    )
                                ).default,
                        } as DropdownActionOption,
                        {
                            ...
                            message: async () =>
                                (
                                    await import(
                                        '../messages/versions/alternate_versions-additional.md?raw'
                                    )
                                ).default,
                        } as DropdownActionOption,
                        {
                            ...
                            message: async () =>
                                (
                                    await import(
                                        '../messages/versions/alternate_versions-mono.md?raw'
                                    )
                                ).default,
                        } as DropdownActionOption,
                        {
                            ...
                            message: async () =>
                                (
                                    await import(
                                        '../messages/versions/alternate_versions-server.md?raw'
                                    )
                                ).default,
                        } as DropdownActionOption,
                        {
                            ...
                            message: async () =>
                                (
                                    await import(
                                        '../messages/versions/alternate_versions-server-additional.md?raw'
                                    )
                                ).default,
                        } as DropdownActionOption,
                        {
                            ...
                            shouldShow: (project) => project.project_type === 'modpack',
                            message: async () =>
                                (await import('../messages/versions/alternate_versions-zip.md?raw'))
                                    .default,
                        } as DropdownActionOption,
                    ],
                } as DropdownAction,
        ...
        } as ButtonAction,
        {
            ...
            weight: 1003,
            shouldShow: (project) =>
                project.project_type === 'mod' || project.project_type === 'plugin',
