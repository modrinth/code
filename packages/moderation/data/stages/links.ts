...
const links: Stage = {
    ...
    text: async (project) => {
        ...
        if (project.donation_urls.length > 0) {
            text += (await import('../messages/checklist-text/links/donation/donations.md?raw'))
                .default

            for (const donation of project.donation_urls) {
                text += (
                    await import(`../messages/checklist-text/links/donation/donation.md?raw`)
                ).default
                    ...
                    options: [
                        {
                            ...
                            message: async () =>
                                (await import('../messages/links/not_accessible-source.md?raw'))
                                    .default,
                        },
                        {
                            label: 'Discord',
                            ...
                            message: async () =>
                                (await import('../messages/links/not_accessible-discord.md?raw'))
                                    .default,
                        },
                    ],
                },
