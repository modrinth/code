...
const statusAlerts: Stage = {
    ...
    text: async () =>
        (await import('../messages/checklist-text/status-alerts/text.md?raw')).default,
    guidance_url:
                    ...
                    options: [
                        {
                            ...
                            message: async () =>
                                (
                                    await import(
                                        '../messages/status-alerts/tec/source_request-obfs.md?raw'
                                    )
                                ).default,
                        } as DropdownActionOption,
                        {
                            ...
                            message: async () =>
                                (
                                    await import(
                                        '../messages/status-alerts/tec/source_request-bins.md?raw'
                                    )
                                ).default,
                        } as DropdownActionOption,
                    ],
