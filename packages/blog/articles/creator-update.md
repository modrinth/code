...
![The analytics for a project, showing downloads, page views, and revenue, with a breakdown by country.](../public/creator-update/project-analytics.jpg)

![A screenshot of the analytics for a user, showing multiple different projects.](../public/creator-update/user-analytics.jpg)
...
You can view the analytics for an individual project by going to the settings and clicking “Analytics”. You can view analytics for all of your projects in [the analytics dashboard](https://modrinth.com/dashboard/analytics).
...
![A screenshot of the Project Odyssey suite of mods as a collection.](../public/creator-update/collections.jpg)

Your [followed projects](https://modrinth.com/collection/following) now make up an automatically generated private collection, which you can access from the [“Your collections” section of the dashboard](https://modrinth.com/dashboard/collections).
...
|----------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------|
| Created through a launcher, such as the [Modrinth App](https://modrinth.com/app).                                                      | Created on the [Modrinth website](https://modrinth.com/dashboard/collections).                                                                |
...
| Must be reviewed by Modrinth’s staff and approved per [Modrinth’s rules](https://modrinth.com/legal/rules) before it can be published. | Does **not** need to be reviewed by Modrinth’s staff. Can go public at any time.                                                              |
...
![The withdrawal screen, with PayPal, Venmo, ACH, Visa, and a preview of two of the available options for the United States (AMC and Airbnb)](../public/creator-update/payout-methods.jpg)
...
![A screenshot of an OAuth app requesting permission to your user profile.](../public/creator-update/oauth.jpg)

You can create a new OAuth application in the [Applications](https://modrinth.com/settings/applications) section of your settings. You can see which applications you’ve granted access to in the [Authorizations](https://modrinth.com/settings/authorizations) section.
