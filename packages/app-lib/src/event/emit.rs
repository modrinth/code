...
#[cfg(feature = "tauri")]
use crate::event::{LoadingPayload, ProcessPayload, ProfilePayload, WarningPayload};
use futures::prelude::*;
#[cfg(feature = "tauri")]
...
#[allow(unused_variables)]
pub async fn emit_profile(profile_path_id: &str, event: ProfilePayloadType) -> crate::Result<()> {
	#[cfg(feature = "tauri")]
	{
		let event_state = crate::EventState::get()?;
		event_state
