...
pub async fn find_filtered_jres(java_version: Option<u32>) -> crate::Result<Vec<JavaVersion>> {
...
pub async fn test_jre(path: PathBuf, major_version: u32) -> crate::Result<bool> {
