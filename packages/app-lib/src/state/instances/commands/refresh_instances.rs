use crate::State;
use crate::state::{LauncherFeatureVersion, InstanceInstallStage};
...
pub(crate) async fn refresh_all_instances() -> crate::Result<()> {
	...
	for instance in instances {
		...
		let launcher_feature_version =
			(instance.launcher_feature_version < LauncherFeatureVersion::MOST_RECENT)
