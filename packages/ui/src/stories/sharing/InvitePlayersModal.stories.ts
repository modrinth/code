...
const apiUsers: Labrinth.Users.v3.SearchUser[] = [
	{
		...
		avatar_url: 'https://cdn.modrinth.com/user/u6dRKJwZ/7ba3bdb11590a64843e9d2ab83ef85eaab42ec8e.png',
	},
	{
		id: 'prospector',
		username: 'Prospector',
		avatar_url: 'https://cdn.modrinth.com/user/PHyAPGui/30a3a3f53866531831db4aa006794e6bbcfc4121.png',
	},
	{
		id: 'fetch',
		username: 'Fetch',
		avatar_url: 'https://cdn.modrinth.com/user/yol4bNw3/ee2c7a7580ed475cfe3cfe8cc92df45ce33031e0.png',
	},
	{
		id: 'imb11',
		username: 'IMB11',
	...
	return {
		...
		setup() {
			...
			async function searchInviteUsers(query: string) {
				...
				return searchUsers.filter((user) => user.username.toLowerCase().startsWith(normalizedQuery))
			}
			...
			function handleInvite(payload: InvitePlayersInvitePayload) {
				...
				if (existingFriend) {
					...
					friends.value = [{ ...payload.user, status: 'pending' }, ...friends.value]
				}
