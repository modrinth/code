    ...
    <div class="grid grid-cols-2 gap-2 mt-4">
        ...
        >
            ...
            <div class="flex flex-col items-start gap-1 font-medium text-primary">
                <span
                    ...
                    :class="{ 'text-contrast': interval === 'monthly' }"
                    >Pay monthly</span
                >
        ...
        >
            ...
            <div class="flex flex-col items-start gap-1 font-medium text-primary">
                <span
                    class="flex items-center gap-1"
                    :class="{ 'text-contrast': interval === 'quarterly' }"
                    >Pay quarterly
                    <span
                        class="text-xs font-bold text-brand px-1.5 py-0.5 rounded-full bg-brand-highlight"
                ...
                <span class="text-sm text-secondary flex items-center gap-1"
                    >{{
                        formatPrice(
                            locale,
                            (prices?.prices?.intervals?.['quarterly'] ?? 0) /
                                monthsInInterval['quarterly'],
                            currency,
                            true,
                        )
                    }}
