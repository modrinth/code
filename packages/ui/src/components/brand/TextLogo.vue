<template>
	...
	>
		<title>Owyx</title>
		<defs>
			<linearGradient id="owyx-ic-fill" x1="0" y1="0" x2="0" y2="1">
			...
			<linearGradient id="owyx-grad-cyan" x1="0" y1="0" x2="0" y2="1">
				<stop offset="0%" stop-color="#bff8ff" />
				<stop offset="45%" stop-color="#00e5ff" />
				<stop offset="100%" stop-color="#0b7a96" />
			</linearGradient>
		</defs>
		<g transform="translate(8,8) scale(1.0)" class="crystal">
			<g stroke="url(#owyx-ic-edge)" stroke-width="0.75" stroke-linejoin="round">
				...
				<path d="M56 46 L32 60 L32 32 Z" fill="url(#owyx-ic-fill)" fill-opacity="0.3" />
		...
		<text
			x="89"
			y="56"
			fill="url(#owyx-grad-cyan)"
			font-family="'Sora','Space Grotesk','Outfit','Geist',system-ui,sans-serif"
			font-weight="600"
			font-size="56"
			letter-spacing="-3"
		>
