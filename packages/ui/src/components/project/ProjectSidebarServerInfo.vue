...
import { CopyIcon, getLoaderIcon } from '@icarus/assets'
import { SERVER_LANGUAGES } from '@icarus/ui'
import { formatVersionsForDisplay, type GameVersionTag, type PlatformTag } from '@icarus/utils'
