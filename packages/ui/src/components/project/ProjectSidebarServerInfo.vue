<template>
	<div v-if="hasContent" class="flex flex-col gap-3">
		...
		<div
			...
			class="bg-button-bg flex gap-2 justify-between rounded-[4px] items-center px-3 pr-1.5 h-12 cursor-pointer hover:bg-button-bg-hover hover:brightness-125 transition-all active:scale-95"
			@click="handleCopyIP"
		>
