	...
	<Transition name="floating-action-bar" appear>
		...
		>
			<div
				...
				class="relative overflow-clip flex items-center gap-2 rounded-[4px] bg-surface-3 border border-surface-5 border-solid mx-auto max-w-[60vw] px-4 py-3 shadow-[0px_1px_3px_0px_rgba(0,0,0,0.3),0px_6px_10px_0px_rgba(0,0,0,0.15)]"
