			...
			<div class="relative isolate flex w-full flex-col gap-4">
				...
				<div v-if="!isEditing">
					<FileUploadDragAndDrop
						ref="fileUploadRef"
						class="@container relative flex flex-col overflow-clip rounded-[5px] border border-solid border-surface-4 shadow-sm"
					...
					>
						...
						<div
							...
							class="flex h-full w-full items-center justify-center rounded-b-[4px] bg-surface-2 p-20"
						>
