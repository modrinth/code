import type { AbstractModrinthClient } from '../core/abstract-client.js'
import type { AbstractModule } from '../core/abstract-module.js'
import { ArchonActionsV1Module } from './archon/actions/v1.js'
import { ArchonBackupsV1Module } from './archon/backups/v1.js'
import { ArchonBackupsQueueV1Module } from './archon/backups-queue/v1.js'
import { ArchonContentV1Module } from './archon/content/v1.js'
import { ArchonNodesInternalModule } from './archon/nodes/internal.js'
import { ArchonNoticesV0Module } from './archon/notices/v0.js'
import { ArchonOptionsV1Module } from './archon/options/v1.js'
import { ArchonPropertiesV1Module } from './archon/properties/v1.js'
import { ArchonServerUsersV1Module } from './archon/server-users/v1.js'
import { ArchonServersV0Module } from './archon/servers/v0.js'
import { ArchonServersV1Module } from './archon/servers/v1.js'
import { ArchonTransfersInternalModule } from './archon/transfers/internal.js'
import { ISO3166Module } from './iso3166/index.js'
import { KyrosContentV1Module } from './kyros/content/v1.js'
import { KyrosFilesV0Module } from './kyros/files/v0.js'
import { KyrosLogsV1Module } from './kyros/logs/v1.js'
import { KyrosUploadSessionsV1Module } from './kyros/upload-sessions/v1.js'
import { LabrinthAffiliateInternalModule } from './labrinth/affiliate/internal.js'
import { LabrinthAnalyticsV3Module } from './labrinth/analytics/v3.js'
import { LabrinthAttributionInternalModule } from './labrinth/attribution/internal.js'
import { LabrinthAuthInternalModule } from './labrinth/auth/internal.js'
import { LabrinthAuthV2Module } from './labrinth/auth/v2.js'
import { LabrinthBillingInternalModule } from './labrinth/billing/internal.js'
import { LabrinthCampaignInternalModule } from './labrinth/campaign/internal.js'
import { LabrinthCollectionsModule } from './labrinth/collections.js'
import { LabrinthContentV3Module } from './labrinth/content/v3.js'
import { LabrinthExternalProjectsInternalModule } from './labrinth/external-projects/internal.js'
import { LabrinthFriendsV3Module } from './labrinth/friends/v3.js'
import { LabrinthGlobalsInternalModule } from './labrinth/globals/internal.js'
import { LabrinthImagesV3Module } from './labrinth/images/v3.js'
import { LabrinthVersionsV2Module, LabrinthVersionsV3Module } from './labrinth/index.js'
import { LabrinthLimitsV3Module } from './labrinth/limits/v3.js'
import { LabrinthModerationInternalModule } from './labrinth/moderation/internal.js'
import { LabrinthNotificationsV2Module } from './labrinth/notifications/v2.js'
import { LabrinthOAuthInternalModule } from './labrinth/oauth/internal.js'
import { LabrinthOrganizationsV3Module } from './labrinth/organizations/v3.js'
import { LabrinthPatsV2Module } from './labrinth/pats/v2.js'
import { LabrinthPayoutV3Module } from './labrinth/payout/v3.js'
import { LabrinthPayoutsV3Module } from './labrinth/payouts/v3.js'
import { LabrinthProjectsV2Module } from './labrinth/projects/v2.js'
import { LabrinthProjectsV3Module } from './labrinth/projects/v3.js'
import { LabrinthReportsV3Module } from './labrinth/reports/v3.js'
import { LabrinthServerPingInternalModule } from './labrinth/server-ping/internal.js'
import { LabrinthSessionsV2Module } from './labrinth/sessions/v2.js'
import { LabrinthStateModule } from './labrinth/state/index.js'
import { LabrinthTagsV2Module } from './labrinth/tags/v2.js'
import { LabrinthTeamsV2Module } from './labrinth/teams/v2.js'
import { LabrinthTeamsV3Module } from './labrinth/teams/v3.js'
import { LabrinthTechReviewInternalModule } from './labrinth/tech-review/internal.js'
import { LabrinthThreadsV3Module } from './labrinth/threads/v3.js'
import { LabrinthUsersV2Module } from './labrinth/users/v2.js'
import { LabrinthUsersV3Module } from './labrinth/users/v3.js'
import { LauncherMetaManifestV0Module } from './launcher-meta/v0.js'
import { MclogsInsightsV1Module } from './mclogs/insights/v1.js'
import { MclogsLogsV1Module } from './mclogs/logs/v1.js'
import { PaperVersionsV3Module } from './paper/v3.js'
import { PurpurVersionsV2Module } from './purpur/v2.js'
