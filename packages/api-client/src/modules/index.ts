...
import { LabrinthExternalLicenseInternalModule } from './labrinth/external-license/internal'
...
export const MODULE_REGISTRY = {
	...
	labrinth_external_license_internal: LabrinthExternalLicenseInternalModule,
