...
static SPECIAL_PARENTS: LazyLock<HashMap<&'static str, &'static str>> = LazyLock::new(|| {
...
pub fn is_feature_supported_in(version: &str, first_release: &str, first_snapshot: &str) -> bool {
	...
	for (part_version, part_first_release) in parts_version.zip(parts_first_release) {
