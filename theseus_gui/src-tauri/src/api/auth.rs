...
#[tauri::command]
pub async fn auth_authenticate_begin_flow(window: tauri::Window) -> Result<url::Url> {
...
#[tauri::command]
pub async fn auth_authenticate_await_completion(window: tauri::Window) -> Result<Credentials> {
    Ok(window_scoped!(window,auth::authenticate_await_complete_flow()).await?)
}

/// Refresh some credentials using Hydra, if needed
// invoke('auth_refresh',user)
#[tauri::command]
pub async fn auth_refresh(window: tauri::Window,
    user: uuid::Uuid,
    update_name: bool,
) -> Result<Credentials> {
...
#[tauri::command]
pub async fn auth_remove_user(window: tauri::Window, user: uuid::Uuid) -> Result<()> {
...
#[tauri::command]
pub async fn auth_has_user(window: tauri::Window, user: uuid::Uuid) -> Result<bool> {
...
// invoke('auth_users',user)
#[tauri::command]
pub async fn auth_get_user(window: tauri::Window, user: uuid::Uuid) -> Result<Credentials> {
