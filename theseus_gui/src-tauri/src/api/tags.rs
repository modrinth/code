...
#[tauri::command]
pub async fn tags_get_categories(window: tauri::Window) -> Result<Vec<Category>> {
    Ok(window_scoped!(window,theseus::tags::get_category_tags()).await?)
}

/// Gets cached report type tags from the database
#[tauri::command]
pub async fn tags_get_report_types(window: tauri::Window) -> Result<Vec<String>> {
...
#[tauri::command]
pub async fn tags_get_game_versions(window: tauri::Window) -> Result<Vec<GameVersion>> {
...
#[tauri::command]
pub async fn tags_get_donation_platforms(window: tauri::Window) -> Result<Vec<DonationPlatform>> {
    Ok(window_scoped!(window,theseus::tags::get_donation_platform_tags()).await?)
}
