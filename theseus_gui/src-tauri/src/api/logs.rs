...
#[tauri::command]
pub async fn logs_get_log_by_datetime(profile_uuid: Uuid, datetime_string: String) -> Result<Logs> {
...
#[tauri::command]
pub async fn logs_get_stdout_by_datetime(profile_uuid: Uuid, datetime_string: String) -> Result<String> {
...
#[tauri::command]
pub async fn logs_get_stderr_by_datetime(profile_uuid: Uuid, datetime_string: String) -> Result<String> {
