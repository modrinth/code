<template>
  ...
  >
    <Avatar
      ...
      :src="selectedAccount ? `https://mc-heads.net/avatar/${selectedAccount.id}/128` : 'https://cdn.discordapp.com/attachments/817413688771608587/1129829843425570867/unnamed.png'"
    />
