...
const authUnreachable = ref(false)
  ...
  const tick = () => {
    check_reachable()
      .then((_resp) => {
        ...
        authUnreachable.value = false
      })
      .catch((err) => {
        authUnreachable.value = true
...
<template>
  ...
  >
    ...
    <Suspense>
      <AuthGrantFlowWaitModal
        ref="modrinthLoginFlowWaitModal"
        @flow-cancel="cancelLogin"
      />
    </Suspense>
    <Suspense>
    ...
    >
      ...
      <NavButton
        ...
        :is-subpage="
          (route) => route.path.startsWith('/project') && !route.query.i
        "
      >
        <CompassIcon />
      </NavButton>
      ...
      >
        ...
        <template #view-profile>
          ...
          <span class="inline-flex items-center gap-1">
            Signed in as
            <span
              class="inline-flex items-center gap-1 text-contrast font-semibold"
            >
              <Avatar
  ...
  >
    <div class="app-viewport flex-grow router-view">
      <transition name="popup-survey">
        ...
        >
          ...
          <p class="m-0 leading-tight">
            Would you mind answering a few questions about your experience with
            Modrinth App?
          </p>
          <p class="mt-3 mb-4 leading-tight">
            This feedback will go directly to the Modrinth team and help guide
            future updates!
          </p>
          <div class="flex gap-2">
            <ButtonStyled color="brand">
              <button @click="openSurvey">
                <NotepadTextIcon /> Take survey
              </button>
            </ButtonStyled>
            <ButtonStyled>
      ...
      <Admonition v-if="authUnreachable" type="warning" header="foobar">
      </Admonition>
      ...
      >
        ...
        >
          ...
          <div
            ...
            class="p-4 pr-1 flex flex-col items-center"
          >
            <h3
              class="text-base mb-4 text-primary font-medium m-0 text-left w-full"
            >
              News
            </h3>
