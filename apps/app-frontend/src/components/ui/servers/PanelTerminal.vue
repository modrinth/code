<template>
  ...
  >
    ...
    <button
      class="absolute appearance-none border-0 outline-none right-4 top-4 grid size-12 place-content-center rounded-lg bg-bg-raised text-contrast transition-transform duration-300 hover:scale-110"
