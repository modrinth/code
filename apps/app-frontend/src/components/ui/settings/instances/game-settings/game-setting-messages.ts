...
const settingMessages = defineMessages({
	...
	graphicsDescription: { id: 'app.settings.game-options.setting.graphics.description', defaultMessage: 'Controls visual quality and performance.' },
	...
	simulationDistanceDescription: { id: 'app.settings.game-options.setting.simulation-distance.description', defaultMessage: 'How far away entities update and blocks and fluids tick.' },
	guiScaleLabel: { id: 'app.settings.game-options.setting.gui-scale.label', defaultMessage: 'GUI scale' },
	guiScaleDescription: { id: 'app.settings.game-options.setting.gui-scale.description', defaultMessage: 'The size of the game interface and HUD.' },
	...
	viewBobbingDescription: { id: 'app.settings.game-options.setting.view-bobbing.description', defaultMessage: 'Add a bobbing motion to the camera while walking.' },
	vsyncLabel: { id: 'app.settings.game-options.setting.vsync.label', defaultMessage: 'VSync' },
	vsyncDescription: { id: 'app.settings.game-options.setting.vsync.description', defaultMessage: 'Limit the frame rate to the display refresh rate to prevent screen tearing.' },
	...
	biomeBlendRadiusDescription: { id: 'app.settings.game-options.setting.biome-blend-radius.description', defaultMessage: 'The distance over which biome colors transition.' },
	...
	musicToastDescription: { id: 'app.settings.game-options.setting.music-toast.description', defaultMessage: 'Choose whether music titles appear in the pause menu and as toasts.' },
	...
	autoJumpDescription: { id: 'app.settings.game-options.setting.auto-jump.description', defaultMessage: 'Automatically jump up one-block-high obstacles.' },
	...
	discreteMouseScrollDescription: { id: 'app.settings.game-options.setting.discrete-mouse-scroll.description', defaultMessage: 'Treat each mouse-wheel input as a single scroll step.' },
	...
	chatLinksDescription: { id: 'app.settings.game-options.setting.chat-links.description', defaultMessage: 'Allow web links in chat to be opened.' },
	...
	subtitlesDescription: { id: 'app.settings.game-options.setting.subtitles.description', defaultMessage: 'Show captions for sounds played in the game.' },
	highContrastLabel: { id: 'app.settings.game-options.setting.high-contrast.label', defaultMessage: 'High contrast' },
	highContrastDescription: { id: 'app.settings.game-options.setting.high-contrast.description', defaultMessage: 'Enhance the contrast of interface elements.' },
	darkSplashLabel: { id: 'app.settings.game-options.setting.dark-splash.label', defaultMessage: 'Monochrome logo' },
	darkSplashDescription: { id: 'app.settings.game-options.setting.dark-splash.description', defaultMessage: 'Change the Mojang Studios loading screen from red to black.' },
	notificationTimeLabel: { id: 'app.settings.game-options.setting.notification-time.label', defaultMessage: 'Notification time' },
	notificationTimeDescription: { id: 'app.settings.game-options.setting.notification-time.description', defaultMessage: 'How long toast notifications remain visible.' },
	mainHandLabel: { id: 'app.settings.game-options.setting.main-hand.label', defaultMessage: 'Main hand' },
	mainHandDescription: { id: 'app.settings.game-options.setting.main-hand.description', defaultMessage: 'Choose whether the main hand is left or right.' },
	capeLabel: { id: 'app.settings.game-options.setting.cape.label', defaultMessage: 'Cape' },
	capeDescription: { id: 'app.settings.game-options.setting.cape.description', defaultMessage: 'Show the player\'s cape, including its elytra texture.' },
	...
	allowServerListingDescription: { id: 'app.settings.game-options.setting.allow-server-listing.description', defaultMessage: 'Allow the player\'s name to appear in server listings.' },
...
const categoryMessages = defineMessages({
	...
	customDescription: { id: 'app.settings.game-options.category.custom.description', defaultMessage: 'Settings added by mods' },
})
...
const choiceMessages = defineMessages({
	...
	pauseAndToast: { id: 'app.settings.game-options.choice.pause-and-toast', defaultMessage: 'Pause menu and toast' },
})

export const presentationMessages = defineMessages({
	customValuePlaceholder: { id: 'app.settings.game-options.custom-value.placeholder', defaultMessage: 'Enter a value' },
	validationLocalValueNeedsSaving: { id: 'app.settings.game-options.validation.local-value-needs-saving', defaultMessage: 'Save this value before turning sync back on.' },
	validationMissingValue: { id: 'app.settings.game-options.validation.missing-value', defaultMessage: 'Choose a value first.' },
	validationNoCompatibleInstances: { id: 'app.settings.game-options.validation.no-compatible-instances', defaultMessage: 'Some of your instances cannot use this setting' },
	validationInvalidValue: { id: 'app.settings.game-options.validation.invalid-value', defaultMessage: 'Choose a valid value.' },
	validationChangedSinceOpened: { id: 'app.settings.game-options.validation.changed-since-opened', defaultMessage: 'This setting changed elsewhere. Check it and try again.' },
	compatibilityNoParticipants: { id: 'app.settings.game-options.compatibility.no-participants', defaultMessage: 'Add an instance to start syncing' },
	compatibilityNone: { id: 'app.settings.game-options.compatibility.none', defaultMessage: 'Some of your instances cannot use this setting' },
	compatibilityAll: { id: 'app.settings.game-options.compatibility.all', defaultMessage: 'Syncs to {count, plural, one {# instance} other {# instances}}' },
	compatibilityAllDisabled: { id: 'app.settings.game-options.compatibility.all-disabled', defaultMessage: 'Sync is off' },
	compatibilitySome: { id: 'app.settings.game-options.compatibility.some', defaultMessage: 'Some of your instances cannot use this setting' },
	compatibilitySomeDisabled: { id: 'app.settings.game-options.compatibility.some-disabled', defaultMessage: 'Some of your instances cannot use this setting' },
	compatibilityTooltipNoParticipants: { id: 'app.settings.game-options.compatibility.tooltip.no-participants', defaultMessage: 'Add an instance to start syncing this setting.' },
	compatibilityTooltipAll: { id: 'app.settings.game-options.compatibility.tooltip.all', defaultMessage: 'All of your instances can use this setting.' },
	compatibilityTooltipLimited: { id: 'app.settings.game-options.compatibility.tooltip.recipients', defaultMessage: 'Some of your instances cannot use this setting' },
	compatibilityTooltipWaiting: { id: 'app.settings.game-options.compatibility.tooltip.waiting', defaultMessage: '{count, plural, one {Launch this instance once before syncing this setting.} other {Launch these instances once before syncing this setting.}}' },
	bucketLauncherControlled: { id: 'app.settings.game-options.compatibility.reason.launcher-controlled', defaultMessage: 'This setting is managed by Modrinth’s launch settings.' },
...
export function formatCompatibilityTooltip(formatMessage: FormatMessage, setting: EditableGameSetting): string {
	...
	const waiting = summary.buckets
		.filter((bucket) => bucket.status === 'waiting_for_file' || bucket.status === 'waiting_for_base')
...
export function shouldShowCompatibilityIndicator(setting: EditableGameSetting): boolean {
	return (
		...
		setting.compatibility.buckets.some(
			(bucket) =>
				bucket.status === 'waiting_for_file' || bucket.status === 'waiting_for_base',
		)
	)
}
