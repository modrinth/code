...
use crate::models::billing::{ChargeStatus, ChargeType, PaymentPlatform, PriceDuration};
...
impl DBCharge {
	...
	pub async fn get_children(
		...
		let res = select_charges_with_predicate!("WHERE parent_charge_id = $1", charge_id)
			.fetch_all(exec)
			.await?;
