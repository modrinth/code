...
impl AuthQueue {
	...
	pub async fn add_session(&self, id: DBSessionId, metadata: SessionMetadata) {
	...
	pub async fn add_oauth_access_token(&self, id: crate::database::models::DBOAuthAccessTokenId) {
