...
use crate::models::ids::{
	NotificationId, ProjectId, ReportId, TeamId, ThreadId, ThreadMessageId, VersionId,
};
		...
		let (name, text, link, actions) = {
			match &notif.body {
				NotificationBody::ProjectUpdate {
					...
					format!("The project {project_id} has released a new version: {version_id}"),
				...
				NotificationBody::OrganizationInvite {
					...
					format!("An invite has been sent for you to be {role} of an organization"),
