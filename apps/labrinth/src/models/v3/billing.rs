use crate::models::ids::{ChargeId, ProductId, ProductPriceId, UserSubscriptionId};
...
{
	fn from(x: crate::database::models::user_subscription_item::DBUserSubscription) -> Self {
		Self {
			id: x.id.into(),
