use super::{DeleteFileData, FileHost, FileHostPublicity, FileHostingError, UploadFileData};
...
fn get_file_path(file_name: &str, file_publicity: FileHostPublicity) -> PathBuf {
