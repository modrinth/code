...
use crate::database::models::users_redeemals::{Offer, RedeemalLookupFields, Status, UserRedeemal};
...
pub async fn verify(
	...
	let maybe_fields = RedeemalLookupFields::redeemal_status_by_username_and_offer(
		&**pool,
		&username,
		Offer::Medal,
	)
