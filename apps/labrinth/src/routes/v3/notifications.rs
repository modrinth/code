...
pub async fn notifications_get(
	...
	let notifications_data: Vec<DBNotification> =
		database::models::notification_item::DBNotification::get_many(&notification_ids, &**pool)
			.await?;
...
pub async fn notification_get(
	...
	let notification_data =
		database::models::notification_item::DBNotification::get(id.into(), &**pool).await?;
...
pub async fn notifications_read(
	...
	let mut notifications: Vec<database::models::ids::DBNotificationId> = Vec::new();
