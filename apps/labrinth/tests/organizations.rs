use crate::common::{
	...
	database::{
		ADMIN_USER_PAT, ENEMY_USER_ID_PARSED, ENEMY_USER_PAT, FRIEND_USER_ID_PARSED, MOD_USER_ID,
		MOD_USER_PAT, USER_USER_ID, USER_USER_ID_PARSED, generate_random_name,
	},
...
use common::{
	...
	environment::{TestEnvironment, with_test_environment, with_test_environment_all},
