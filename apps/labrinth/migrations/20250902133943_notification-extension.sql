...
CREATE INDEX idx_notifications_deliveries_composite_queue ON notifications_deliveries (
	channel,
	status,
	next_attempt ASC,
...
CREATE INDEX idx_notifications_deliveries_user_id ON notifications_deliveries (user_id);
...
CREATE INDEX idx_users_notifications_preferences_user_id ON users_notifications_preferences (
	user_id
);

CREATE UNIQUE INDEX idx_users_notifications_preferences_partial_contextual_uniq ON users_notifications_preferences (
	COALESCE(user_id, -1),
	channel,
	notification_type
);
...
VALUES ('reset_password', 3, FALSE, FALSE);
INSERT INTO notifications_types
	(name, delivery_priority, expose_in_user_preferences, expose_in_site_notifications)
VALUES ('project_update', 1, TRUE, TRUE);
INSERT INTO notifications_types
	(name, delivery_priority, expose_in_user_preferences, expose_in_site_notifications)
VALUES ('team_invite', 1, TRUE, TRUE);
INSERT INTO notifications_types
	(name, delivery_priority, expose_in_user_preferences, expose_in_site_notifications)
VALUES ('organization_invite', 1, TRUE, TRUE);
INSERT INTO notifications_types
	(name, delivery_priority, expose_in_user_preferences, expose_in_site_notifications)
VALUES ('status_change', 1, TRUE, TRUE);
INSERT INTO notifications_types
	(name, delivery_priority, expose_in_user_preferences, expose_in_site_notifications)
VALUES ('moderator_message', 1, TRUE, TRUE);
INSERT INTO notifications_types
	(name, delivery_priority, expose_in_user_preferences, expose_in_site_notifications)
VALUES ('legacy_markdown', 1, FALSE, TRUE);
INSERT INTO notifications_types
	(name, delivery_priority, expose_in_user_preferences, expose_in_site_notifications)
VALUES ('unknown', 1, FALSE, TRUE);
INSERT INTO notifications_types
	(name, delivery_priority, expose_in_user_preferences, expose_in_site_notifications)
VALUES ('verify_email', 3, FALSE, FALSE);
INSERT INTO notifications_types
	(name, delivery_priority, expose_in_user_preferences, expose_in_site_notifications)
VALUES ('auth_provider_added', 2, FALSE, FALSE);
INSERT INTO notifications_types
	(name, delivery_priority, expose_in_user_preferences, expose_in_site_notifications)
VALUES ('auth_provider_removed', 2, FALSE, FALSE);
INSERT INTO notifications_types
	(name, delivery_priority, expose_in_user_preferences, expose_in_site_notifications)
VALUES ('two_factor_enabled', 2, FALSE, FALSE);
INSERT INTO notifications_types
	(name, delivery_priority, expose_in_user_preferences, expose_in_site_notifications)
VALUES ('two_factor_removed', 2, FALSE, FALSE);
INSERT INTO notifications_types
	(name, delivery_priority, expose_in_user_preferences, expose_in_site_notifications)
VALUES ('password_changed', 2, FALSE, FALSE);
INSERT INTO notifications_types
	(name, delivery_priority, expose_in_user_preferences, expose_in_site_notifications)
VALUES ('password_removed', 2, FALSE, FALSE);
INSERT INTO notifications_types
	(name, delivery_priority, expose_in_user_preferences, expose_in_site_notifications)
VALUES ('email_changed', 2, FALSE, FALSE);
INSERT INTO notifications_types
	(name, delivery_priority, expose_in_user_preferences, expose_in_site_notifications)
VALUES ('payment_failed', 2, FALSE, FALSE);
...
VALUES
	(
		'email',
		'reset_password',
		'Reset your Modrinth password',
		'https://modrinth.com/email/reset-password',
		CONCAT(
			'Hi {user.name},',
			CHR(10),
			CHR(10),
...
VALUES
	(
		'email',
		'verify_email',
		'Verify your Modrinth email',
		'https://modrinth.com/email/verify-email',
		CONCAT(
			'Hi {user.name},',
			CHR(10),
			CHR(10),
...
VALUES
	(
		...
		'https://modrinth.com/email/auth-provider-added',
		CONCAT(
			'Hi {user.name},',
			CHR(10),
			CHR(10),
			'When logging into Modrinth, you can now log in using the ',
			'{authprovider.name}',
...
VALUES
	(
		...
		'https://modrinth.com/email/auth-provider-removed',
		CONCAT(
			'Hi {user.name},',
			CHR(10),
			CHR(10),
			'When logging into Modrinth, you can no longer log in using the ',
			'{authprovider.name}',
			' authentication provider.',
			CHR(10),
			'If you did not make this change, please contact us immediately by replying to this email or through our support portal at https://support.modrinth.com (using',
...
VALUES
	(
		...
		'https://modrinth.com/email/two-factor-enabled',
		CONCAT(
			'Hi {user.name},',
			CHR(10),
			CHR(10),
...
VALUES
	(
		...
		'https://modrinth.com/email/two-factor-removed',
		CONCAT(
			'Hi {user.name},',
			CHR(10),
			CHR(10),
...
VALUES
	(
		'email',
		'password_changed',
		'Your Modrinth password was changed',
		'https://modrinth.com/email/password-changed',
		CONCAT(
			'Hi {user.name},',
			CHR(10),
			CHR(10),
...
VALUES
	(
		'email',
		'password_removed',
		'Your Modrinth password was removed',
		'https://modrinth.com/email/password-removed',
		CONCAT(
			'Hi {user.name},',
			CHR(10),
			CHR(10),
...
VALUES
	(
		'email',
		'email_changed',
		'Your Modrinth email was changed',
		'https://modrinth.com/email/email-changed',
		CONCAT(
			'Hi {user.name},',
			CHR(10),
			CHR(10),
...
VALUES
	(
		...
		'https://modrinth.com/email/payment-failed',
		CONCAT(
			'Hi {user.name},',
			CHR(10),
			CHR(10),
