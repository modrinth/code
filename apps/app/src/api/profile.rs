...
#[tauri::command]
pub async fn profile_get_mod_full_path(path: &str, project_path: &str) -> Result<PathBuf> {
...
#[tauri::command]
pub async fn profile_get_optimal_jre_key(path: &str) -> Result<Option<JavaVersion>> {
...
#[tauri::command]
pub async fn profile_check_installed(path: &str, project_id: &str) -> Result<bool> {
...
#[tauri::command]
pub async fn profile_update_project(path: &str, project_path: &str) -> Result<String> {
...
#[tauri::command]
pub async fn profile_add_project_from_version(path: &str, version_id: &str) -> Result<String> {
...
pub async fn profile_add_project_from_path(
	...
	let res = profile::add_project_from_path(path, project_path, project_type).await?;
	Ok(res)
}
...
#[tauri::command]
pub async fn profile_toggle_disable_project(path: &str, project_path: &str) -> Result<String> {
...
#[tauri::command]
pub async fn profile_remove_project(path: &str, project_path: &str) -> Result<()> {
...
pub async fn profile_update_managed_modrinth_version(
	...
	Ok(profile::update::update_managed_modrinth_version(&path, &version_id).await?)
}
...
#[tauri::command]
pub async fn profile_get_pack_export_candidates(profile_path: &str) -> Result<Vec<String>> {
...
#[tauri::command]
pub async fn profile_edit_icon(path: &str, icon_path: Option<&Path>) -> Result<()> {
