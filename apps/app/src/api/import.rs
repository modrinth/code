...
pub async fn import_instance(
	...
	import::import_instance(profile_path, launcher_type, base_path, instance_folder).await?;
	Ok(())
}
...
pub async fn is_valid_importable_instance(
	...
	Ok(import::is_valid_importable_instance(instance_folder, launcher_type).await)
}
