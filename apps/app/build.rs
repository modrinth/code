	...
	tauri_build::try_build(
		tauri_build::Attributes::new()
			...
			.plugin(
				"metadata",
				InlinedPlugin::new()
					.commands(&["metadata_get_game_versions", "metadata_get_loader_versions"])
					.default_permission(DefaultPermissionRule::AllowAllCommands),
			)
			.plugin(
				"minecraft-skins",
			...
			.plugin(
				"mr-auth",
				InlinedPlugin::new()
					.commands(&["modrinth_login", "logout", "get", "cancel_modrinth_login"])
					.default_permission(DefaultPermissionRule::AllowAllCommands),
			)
			.plugin(
				"pack",
			...
			.plugin(
				"settings",
				InlinedPlugin::new()
					.commands(&["settings_get", "settings_set", "cancel_directory_change"])
					.default_permission(DefaultPermissionRule::AllowAllCommands),
			)
			.plugin(
				"tags",
			...
			.plugin(
				"friends",
				InlinedPlugin::new()
					.commands(&["friends", "friend_statuses", "add_friend", "remove_friend"])
					.default_permission(DefaultPermissionRule::AllowAllCommands),
			)
			.plugin(
				"worlds",
