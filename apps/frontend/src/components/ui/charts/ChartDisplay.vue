            ...
            <div class="graphs__main-graph">
                                ...
                                <Chart
                                    ...
                                    :colors="
                                        isUsingProjectColors
                                            ...
                                            : analytics.formattedData.value.views.chart
                                                  .defaultColors
                                    "
                                />
                                <Chart
                ...
                <div class="country-data">
                    ...
                    >
                        ...
                        <div class="country-values">
                            <div
                                v-for="[name, count] in analytics.formattedData.value.viewsByCountry
                                    .data"
                                :key="name"
                                class="country-value"
                            >
...
const formattedCategorySubtitle = computed(() => {
    return (
        selectedRange.value?.getLabel([dayjs(startDate.value), dayjs(endDate.value)]) ??
        'Loading...'
    )
})
