        ...
        >
            <span class="text-md flex flex-col gap-2 sm:flex-row sm:items-center">
                <span class="flex items-center gap-2">
                    Reported for
                    <span
                        class="whitespace-nowrap rounded-full align-middle font-semibold text-contrast"
                    >
                        {{ formattedReportType }}
                    </span>
                </span>
            ...
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                <div class="flex min-w-0 flex-1 items-center gap-3">
                    ...
                    <div class="min-w-0 flex-1">
                        ...
                        <div
                            class="flex flex-col gap-2 text-sm text-secondary sm:flex-row sm:items-center"
                        >
                            <nuxt-link
                            ...
                            <div class="flex flex-wrap items-center gap-2">
                                ...
                                >
                                    {{
                                        report.version.files.find((file) => file.primary)
