        ...
        <div class="flex flex-col gap-4 md:w-[600px]">
            ...
            <div v-if="!isSecondPhase" class="flex flex-col gap-4">
                ...
                <div class="flex w-full flex-col gap-2 rounded-2xl bg-table-alternateRow p-4">
                    ...
                    <div class="mt-2 flex items-center justify-between gap-2">
                        <label for="toggle-snapshots" class="font-semibold">
                            Show snapshot versions
                        </label>
                        <div
                            v-tooltip="
                                isSnapshotSelected
                                    ? 'A snapshot version is currently selected.'
                                    : undefined
                            "
                        >
                            <Toggle
                ...
                >
                    <div class="flex flex-col gap-2">
                        <div class="text-lg font-bold text-contrast">
                ...
                >
                    ...
                    <div>
                        Removes all data on your server, including your worlds, mods, and
                        configuration files, then reinstalls it with the selected version.
                    </div>
                    <div class="font-bold">
            ...
            <div class="mt-4 flex justify-start gap-4">
                <ButtonStyled :color="isDangerous ? 'red' : 'brand'">
                    <button
                        v-tooltip="
                            backupInProgress ? formatMessage(backupInProgress.tooltip) : undefined
                        "
...
const checkVersionAvailability = async (version: string) => {
    ...
    try {
        const mcRes =
            cachedVersions.value[version] || (await getLoaderVersion('minecraft', version))
