    ...
    >
        <div class="flex flex-col gap-4 md:w-[600px]">
            <div class="flex flex-col gap-2">
                <p class="m-0">
                    Select the version of {{ props.project?.title || 'the modpack' }} you want to
            ...
            <div class="flex w-full flex-col gap-4">
                ...
                <div class="flex w-full flex-col gap-2 rounded-2xl bg-table-alternateRow p-4">
                    ...
                    <div>
                        If enabled, existing mods, worlds, and configurations, will be deleted
                        before installing the new modpack version.
                    </div>
                </div>
                ...
                <div class="mt-4 flex justify-start gap-4">
                    <ButtonStyled :color="hardReset ? 'red' : 'brand'">
                        <button
                            :disabled="
                                isLoading || !selectedVersion || props.serverStatus === 'installing'
                            "
