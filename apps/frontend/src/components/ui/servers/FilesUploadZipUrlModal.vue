    ...
    >
        <form class="flex flex-col gap-4 md:w-[600px]" @submit.prevent="handleSubmit">
            <div class="flex flex-col gap-2">
                ...
                <ol
                    v-if="cf"
                    class="mb-1 mt-0 flex flex-col gap-1 pl-8 leading-normal text-secondary"
                >
                    <li>
                        <a
                    ...
                    <li>
                        ...
                        <span class="font-semibold text-primary">select the version</span> of the
                        modpack you want to install.
                    </li>
                    <li>
                        <span class="font-semibold text-primary">Copy the URL</span> of the version
                        you want to install, and paste it in the box below.
                    </li>
                </ol>
                <p v-else class="mb-1 mt-0">
