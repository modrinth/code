    ...
    >
        ...
        >
            <div class="flex flex-row gap-2">
                <UiServersIconsPanelErrorIcon class="!size-5" /> Your server has been cancelled.
                Please update your billing information or contact Modrinth Support for more
                information.
            </div>
        ...
        >
            <div class="flex flex-row gap-2">
                ...
                {{ suspension_reason }}. Please update your billing information or contact Modrinth
