<template>
    <NewModal ref="modal" header="Editing auto backup settings">
        <div class="flex flex-col gap-4 md:w-[600px]">
            ...
            <div v-if="isLoadingSettings" class="py-2 text-sm text-secondary">
                Loading settings...
            </div>
            <template v-else>
                <input
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <p class="m-0">
                        The amount of time between each backup. This will only backup your server if
