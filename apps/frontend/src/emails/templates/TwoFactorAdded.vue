...
<template>
	<StyledEmail title="Two-factor authentication enabled">
		...
		<Text class="text-muted text-base">
			When logging into Modrinth, you can now enter a code generated by your authenticator app in
			addition to entering your usual email address and password.
		</Text>
		<Text class="text-muted text-base">
