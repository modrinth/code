    ...
    <div>
        <section class="universal-card">
            ...
            <div v-else-if="isUnderReview(project)">
                <p>
                    Modrinth's team of content moderators work hard to review all submitted
                    projects. Typically, you can expect a new project to be reviewed within 24 to 48
                    hours. Please keep in mind that larger projects, especially modpacks, may
                    require more time to review. Certain holidays or events may also lead to delays
                    depending on moderator availability. Modrinth's moderators will leave a message
            ...
            <template v-else-if="isRejected(project)">
                <p>
                    ...
                    >
                    and the moderators have requested you make changes before it can be approved.
                    Read the messages from the moderators below and address their comments before
                    resubmitting.
                </p>
                <p class="warning">
                    <IssuesIcon /> Repeated submissions without addressing the moderators' comments
                    may result in an account suspension.
                </p>
            </template>
        ...
        <section id="messages" class="universal-card">
            <h2>Messages</h2>
            <p>
                This is a private conversation thread with the Modrinth moderators. They may message
                you with issues concerning this project. This thread is only checked when you submit
                your project for review. For additional inquiries, please go to the
            ...
            <p v-if="isApproved(project)" class="warning">
                <IssuesIcon /> The moderators do not actively monitor this chat. However, they may
                still see messages here if there is a problem with your project.
            </p>
            <ConversationThread
                v-if="thread"
                :thread="thread"
