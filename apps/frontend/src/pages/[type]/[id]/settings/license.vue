    ...
    <div>
        <section class="universal-card">
            ...
            <p class="label__description">
                ...
                our list or provide a custom license. You may also provide a custom URL to your
                chosen license; otherwise, the license text will be displayed. See our
                <nuxt-link
            ...
            <div v-if="license.requiresOnlyOrLater" class="adjacent-input">
                <label for="or-later-checkbox">
                    ...
                    <span class="label__description">
                        The license you selected has an "or later" clause. If you check this box,
                        users may use your project under later editions of the license.
                    </span>
                </label>
            ...
            <div class="adjacent-input">
                <label for="license-url">
                    ...
                    <span v-if="license?.friendly !== 'Custom'" class="label__description">
                        The web location of the full license text. If you don't provide a link, the
                        license text will be displayed instead.
                    </span>
                    <span v-else class="label__description">
                        The web location of the full license text. You have to provide a link since
            ...
            <div v-if="license?.friendly === 'Custom'" class="adjacent-input">
                ...
                <label v-else for="license-name">
                    ...
                    <span class="label__description"
                        >The full name of the license. If the license has a SPDX identifier, please
                        uncheck the checkbox and use the identifier instead.</span
                    >
                </label>
