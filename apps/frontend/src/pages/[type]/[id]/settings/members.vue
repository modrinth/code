    ...
    <div>
        ...
        <Card>
            ...
            <span class="label">
                ...
                <span class="label__description">
                    Enter the Modrinth username of the person you'd like to invite to be a member of
                    this project.
                </span>
            </span>
            ...
            <div class="adjacent-input">
                <span class="label">
                    ...
                    <span class="label__description">
                        Remove yourself as a member of this project.
                    </span>
                </span>
                <button
            ...
            <div class="content">
                ...
                <div class="adjacent-input">
                    ...
                    >
                        ...
                        <span class="label__description">
                            Relative to all other members' monetization weights, this determines
                            what portion of this project's revenue goes to this member.
                        </span>
                    </label>
                    <input
                    ...
                    <div v-if="allTeamMembers[index]" class="permissions">
                        <Checkbox
                            ...
                            :disabled="
                                ...
                                (props.currentMember?.permissions & UPLOAD_VERSION) !==
                                    UPLOAD_VERSION
                            "
                            label="Upload version"
                            @update:model-value="
                                allTeamMembers[index].permissions ^= UPLOAD_VERSION
                            "
                        />
                        <Checkbox
                            ...
                            :disabled="
                                (props.currentMember?.permissions & EDIT_MEMBER) !== EDIT_MEMBER ||
                                (props.currentMember?.permissions & DELETE_VERSION) !==
                                    DELETE_VERSION
                            "
                            label="Delete version"
                            @update:model-value="
                                allTeamMembers[index].permissions ^= DELETE_VERSION
                            "
                        />
                        <Checkbox
                        ...
                        <Checkbox
                            ...
                            :disabled="
                                (props.currentMember?.permissions & EDIT_MEMBER) !== EDIT_MEMBER ||
                                (props.currentMember?.permissions & MANAGE_INVITES) !==
                                    MANAGE_INVITES
                            "
                            label="Manage invites"
                            @update:model-value="
                                allTeamMembers[index].permissions ^= MANAGE_INVITES
                            "
                        />
                        <Checkbox
                        ...
                        <Checkbox
                            ...
                            :disabled="
                                (props.currentMember?.permissions & EDIT_MEMBER) !== EDIT_MEMBER ||
                                (props.currentMember?.permissions & DELETE_PROJECT) !==
                                    DELETE_PROJECT
                            "
                            label="Delete project"
                            @update:model-value="
                                allTeamMembers[index].permissions ^= DELETE_PROJECT
                            "
                        />
                        <Checkbox
                            ...
                            :disabled="
                                (props.currentMember?.permissions & EDIT_MEMBER) !== EDIT_MEMBER ||
                                (props.currentMember?.permissions & VIEW_ANALYTICS) !==
                                    VIEW_ANALYTICS
                            "
                            label="View analytics"
                            @update:model-value="
                                allTeamMembers[index].permissions ^= VIEW_ANALYTICS
                            "
                        />
                        <Checkbox
        ...
        <section class="universal-card">
            ...
            <div v-if="props.organization">
                <p>
                    This project is managed by {{ props.organization.name }}. The defaults for
                    member permissions are set in the
            ...
            <div class="content">
                <div class="adjacent-input">
                    <label :for="`member-${allOrgMembers[index].user.username}-override-perms`">
                        ...
                        <span class="label__description">
                            Override organization default values and assign custom permissions,
                            roles, and monetization weights to this user on the project.
                        </span>
                    </label>
                    <input
                ...
                <template v-if="!member.is_owner">
                    ...
                    <div class="permissions">
                        ...
                        <Checkbox
                            ...
                            :disabled="
                                (props.currentMember?.permissions & EDIT_MEMBER) !== EDIT_MEMBER ||
                                (props.currentMember?.permissions & EDIT_DETAILS) !==
                                    EDIT_DETAILS ||
                                !allOrgMembers[index].override
                            "
                            label="Edit details"
                        ...
                        <Checkbox
                            ...
                            :disabled="
                                (props.currentMember?.permissions & EDIT_MEMBER) !== EDIT_MEMBER ||
                                (props.currentMember?.permissions & REMOVE_MEMBER) !==
                                    REMOVE_MEMBER ||
                                !allOrgMembers[index].override
                            "
                            label="Remove member"
                        ...
                        <Checkbox
                            ...
                            :disabled="
                                (props.currentMember?.permissions & EDIT_MEMBER) !== EDIT_MEMBER ||
                                (props.currentMember?.permissions & VIEW_PAYOUTS) !==
                                    VIEW_PAYOUTS ||
                                !allOrgMembers[index].override
                            "
                            label="View revenue"
