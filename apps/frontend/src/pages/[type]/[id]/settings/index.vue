<template>
    <div>
                ...
                <div class="adjacent-input">
                    <label for="project-env-server">
                        ...
                        <span class="label__description">
                            Select based on if the
                            {{ formatProjectType(project.project_type).toLowerCase() }} has
                            functionality on the <strong>logical</strong> server. Remember that
                            Singleplayer contains an integrated server.
                        </span>
                    </label>
                    <Multiselect
            ...
            <div class="adjacent-input">
                <label for="project-visibility">
                    ...
                    <div class="label__description">
                        Public and archived projects are visible in search. Unlisted projects are
                        published, but not visible in search or on user profiles. Private projects
                        are only accessible by members of the project.
        ...
        <section class="universal-card">
            ...
            <p>
                Removes your project from Modrinth's servers and search. Clicking on this will
