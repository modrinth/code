        ...
        <Modal v-if="auth.user && currentMember" ref="modal_package_mod" header="Package data pack">
            <div class="modal-package-mod universal-labels">
                <div class="markdown-body">
                    <p>
                        Package your data pack as a mod. This will create a new version with support
                        for the selected mod loaders. You will be redirected to the new version and
        ...
        <div class="version-page__title universal-card">
            ...
            <div v-if="fieldErrors && showKnownErrors" class="known-errors">
                <ul>
                    ...
                    <li
                        v-if="
                            version.loaders.length === 0 && project.project_type !== 'resourcepack'
                        "
                    >
        ...
        >
            ...
            >
                ...
                <div class="info">
                    ...
                    <span class="dep-type" :class="dependency.dependency_type"
            ...
            <div v-if="isEditing && project.project_type !== 'modpack'" class="add-dependency">
                ...
                <div class="input-group">
                    ...
                    <input
                        ...
                        @keyup.enter="
                            addDependency(dependencyAddMode, newDependencyId, newDependencyType)
                        "
                    />
                    <Multiselect
