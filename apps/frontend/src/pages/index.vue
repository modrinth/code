<template>
    <div>
        <div class="landing-hero">
            ...
            <h2>
                Discover, play, and share Minecraft content through our open-source platform built
                for the community.
            </h2>
            ...
            <div class="users-section">
                <div class="section-header">
                    ...
                    <p class="section-description">
                        From magical biomes to cursed dungeons, you can be sure to find content to
                        bring your gameplay to the next level.
                    </p>
                </div>
                <div class="feature-blob">
                    <div class="blob-text">
                        ...
                        <p>
                            Modrinth's lightning-fast search and powerful filters let you find what
                                        ...
                                        <p class="notif-desc">
                                            ...
                                            {{
                                                notification.versions[
                                                    notification.versions.length - 1
                                                ]
                                            }}
                                        </p>
                                        <div class="date">
                ...
                <div class="feature-blob">
                    <div class="blob-text">
                        ...
                        <p>
                            ...
                            Modrinth. You can use Modrinth through
                            <nuxt-link class="title-link" to="/app">our own app</nuxt-link>
                            and some of the most popular launchers like ATLauncher, MultiMC, and
                            Prism Launcher.
                        </p>
                    </div>
                    <div class="blob-demonstration gradient-border">
        ...
        <div class="creator-section">
            <div class="section-header">
                ...
                <p class="section-description">
                    Give an online home to your creations and reach a massive audience of dedicated
                    players
                </p>
            </div>
            <div class="features">
                <div class="feature gradient-border">
                    ...
                    <h3>Discovery</h3>
                    <p>
                        Get your project discovered by thousands of users through search, our home
                        page, Discord server, and more ways to come in the future!
                    </p>
                </div>
                <div class="feature gradient-border">
                    <div class="icon gradient-border">
                ...
                <div class="feature gradient-border">
                    ...
                    <h3>Monetization</h3>
                    <p>
                        Get paid ad revenue from your project pages and withdraw your funds at any
                        time
                    </p>
                </div>
                <div class="feature gradient-border">
                    ...
                    <p>
                        Integrate with your build tools through Minotaur for automatic uploads right
