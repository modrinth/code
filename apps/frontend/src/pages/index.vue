...
.landing-hero {
  &::before {
    ...
    position: absolute;
    inset: 0;
    background: var(--landing-maze-bg);
    ...
    .feature-blob {
      ...
      .blob-demonstration {
        ...
        &:after {
          ...
          background: linear-gradient(0deg, #ce4b05 0%, rgba(206, 5, 5, 0) 100%);
          opacity: 0.2;
          border-radius: 0;
          margin-top: auto;
        ...
        .launcher-view {
          .minecraft-screen {
            ...
            filter: saturate(0.25) hue-rotate(260deg);
          }
...
.main-header-strong {
  ...
  background-image: linear-gradient(180deg, #ffe6a7 0%, var(--color-brand) 60%);
  background-size: 100%;
