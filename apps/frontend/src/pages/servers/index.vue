    ...
    >
        ...
        >
            <div class="z-[5] flex w-full flex-col gap-8">
                <div class="flex flex-col gap-4">
                    ...
                    <h1
                        class="relative m-0 max-w-3xl text-3xl font-bold !leading-[110%] md:text-6xl"
                    >
                ...
                >
                    Modrinth Servers is the easiest way to host your own Minecraft: Java Edition
                    server. Seamlessly install and play your favorite mods and modpacks, all within
                    the Modrinth platform.
                </h2>
                <div
                    class="relative flex w-full flex-wrap items-center gap-8 align-middle sm:w-fit"
                >
                    <div
        ...
        >
            ...
            <div class="relative mx-auto flex w-full max-w-7xl flex-col gap-8">
                ...
                >
                    Choose from the thousands of modpacks on Modrinth or create your own. Invite
                    your friends when you're ready to play.
                </h2>
                <img
                ...
                <div class="relative grid w-full grid-cols-1 gap-8 lg:grid-cols-2">
                    <div
                        class="relative flex flex-col gap-4 rounded-2xl bg-bg p-6 text-left md:p-12"
                    >
                        <svg
                        ...
                        <h3 class="m-0 text-base font-normal text-secondary">
                            Modrinth Servers seamlessly integrates the mod and modpack installation
                            process into your server.
                        </h3>
                    </div>
                    ...
                    >
                        ...
                        <h3 class="m-0 text-base font-normal text-secondary">
                            Choose between Vanilla, Fabric, Forge, Quilt and NeoForge. If it's on
                            Modrinth, it can run on your server.
                        </h3>
                    </div>
                </div>
                <div class="relative">
                ...
                <div class="grid w-full grid-cols-1 gap-8 lg:grid-cols-3">
                    <div class="flex flex-col gap-4 rounded-2xl bg-bg p-6 text-left md:p-12">
                        ...
                        <h3 class="m-0 text-base font-normal text-secondary">
                            Your server, mods, players, and more are all on Modrinth. No need to
                    ...
                    >
                        ...
                        <h3 class="m-0 text-base font-normal text-secondary">
                            ...
                            <span class="text-contrast"
                                >high-performance AMD CPUs with DDR5 RAM</span
                            >, running on custom-built software to ensure your server performs
                            smoothly.
                        </h3>
                    </div>
                    ...
                    >
                        ...
                        <h3 class="m-0 text-base font-normal text-secondary">
                            Our infrastructure is never overloaded, meaning each server hosted with
                            Modrinth always runs at its full performance.
                        </h3>
                    </div>
                </div>
            </div>
        ...
        >
            ...
            <div class="relative mx-auto flex w-full max-w-7xl flex-col gap-8">
                ...
                >
                    Included with every server is a suite of features designed to provide a hosting
                    experience that only Modrinth can offer.
                </h2>
                <img
                ...
                <div class="grid grid-cols-1 gap-9 lg:grid-cols-2">
                    ...
                    >
                        ...
                        <h3 class="m-0 text-base font-normal">
                            Search, manage, edit, and upload files directly to your server with
                            ease.
                        </h3>
                ...
                <div class="grid w-full grid-cols-1 gap-8 lg:grid-cols-2">
                    ...
                    >
                        ...
                        <h3 class="m-0 text-base font-normal text-secondary">
                            Add your own domain to your server, reserve up to 15 ports for mods that
                            require them, and more.
                        </h3>
                    </div>
                </div>
                <div class="relative flex flex-col gap-4 rounded-2xl bg-bg p-6 text-left md:p-12">
                    ...
                    <div class="details-hide flex flex-col gap-1">
                        <details pyro-hash="cpus" class="group" :open="$route.hash === '#cpus'">
                            <summary
                                class="flex cursor-pointer items-center py-3 font-medium text-contrast"
                            >
                                <span
                                    class="mr-2 transition-transform duration-200 group-open:rotate-90"
                                >
                                    <RightArrowIcon />
                                </span>
                            ...
                            <p class="m-0 ml-6 leading-[160%]">
                                Modrinth Servers are powered by AMD Ryzen 7900 and 7950X3D
                                equivalent CPUs at 5+ GHz, paired with DDR5 memory.
                            </p>
                        </details>
                        <details
                            pyro-hash="cpu-burst"
                            class="group"
                            :open="$route.hash === '#cpu-burst'"
                        >
                            <summary
                                class="flex cursor-pointer items-center py-3 font-medium text-contrast"
                            >
                            ...
                            <p class="m-0 ml-6 leading-[160%]">
                                When your server is under heavy load, we temporarily give it access
                                to additional CPU threads to help mitigate lag spikes and
                                instability. This helps prevent the TPS from going below 20,
                                ensuring the smoothest experience possible. Since those extra CPU
                                threads are only shortly available during high load periods, they
                                might not show up in Spark reports or other profiling tools.
                            </p>
                        </details>
                        ...
                        <details pyro-hash="ddos" class="group" :open="$route.hash === '#ddos'">
                            ...
                            <p class="m-0 ml-6 leading-[160%]">
                                Yes. All Modrinth Servers come with DDoS protection, with up to
                                17Tbps capacity in some locations.
                            </p>
                        </details>
                        ...
                        <details pyro-hash="region" class="group" :open="$route.hash === '#region'">
                            ...
                            <p class="m-0 ml-6 leading-[160%]">
                                We have servers available in North America and Europe at the moment
                                that you can choose upon purchase. More regions to come in the
                                future! If you'd like to switch your region, please contact support.
                            </p>
                        </details>
                        ...
                        >
                            ...
                            <p class="m-0 ml-6 leading-[160%]">
                                Yes, storage can be increased on your server at no additional cost.
                                If you need more storage, reach out to Modrinth Support.
                            </p>
                        </details>

                        <details
                            pyro-hash="performance"
                            class="group"
                            :open="$route.hash === '#performance'"
                        >
                            <summary
                                class="flex cursor-pointer items-center py-3 font-medium text-contrast"
                            >
                            ...
                            <p class="m-0 ml-6 leading-[160%]">
                                Modrinth Servers are hosted on very modern high-performance
                                hardware, but it's tough to say how exactly that will translate into
                                how fast your server will run because there are so many factors that
                                affect it, such as the mods, data packs, or plugins you're running
                                on your server, and even user behavior.
                            </p>
                            <p class="mb-0 ml-6 mt-3 leading-[160%]">
                                Most performance issues that arise tend to be the fault of an
                                unoptimized modpack, mod, data pack, or plugin that causes the
                                server to lag. Since our servers are very high-end, you shouldn't
                                run into much trouble as long as you pick an appropriate plan for
                                the content you're running on the server.
                            </p>
                        </details>
                        ...
                        >
                            ...
                            <p class="m-0 ml-6 leading-[160%]">
                                Modrinth Servers can run any version of Minecraft: Java Edition
                                going all the way back to version 1.2.5, including snapshot
                                versions.
                            </p>
                            <p class="m-0 ml-6 mt-3 leading-[160%]">
                                We also support a wide range of mod and plugin loaders, including
                                Fabric, Quilt, Forge, and NeoForge for mods, as well as Paper and
                                Purpur for plugins. Availability depends on whether the mod or
                                plugin loader supports the selected Minecraft version.
                            </p>
                        </details>
                    </div>
                </div>
            ...
            <div class="mx-auto flex w-full max-w-7xl flex-col items-center gap-8 text-center">
                ...
                <ul class="m-0 flex w-full grid-cols-3 flex-col gap-8 p-0 lg:grid">
                    <ServerPlanSelector
                        ...
                        :price="
                            plans.small?.prices?.find((x) => x.currency_code === selectedCurrency)
                                ?.prices?.intervals?.[billingPeriod]
                        "
                    ...
                    <ServerPlanSelector
                        ...
                        :price="
                            plans.medium?.prices?.find((x) => x.currency_code === selectedCurrency)
                                ?.prices?.intervals?.[billingPeriod]
                        "
                        :interval="billingPeriod"
                        :currency="selectedCurrency"
                    ...
                    <ServerPlanSelector
                        ...
                        :price="
                            plans.large?.prices?.find((x) => x.currency_code === selectedCurrency)
                                ?.prices?.intervals?.[billingPeriod]
                        "
                        :currency="selectedCurrency"
                        :is-usa="country.toLowerCase() === 'us'"
...
const selectProduct = async (product) => {
    if (loggedOut.value) {
        data.$router.push(
            `/auth/sign-in?redirect=${encodeURIComponent('/servers?plan=' + product)}`,
        )
        return
    }
            ...
            setTimeout(
                () => {
                    ...
                    const median = Math.round(
                        [...pings].sort((a, b) => a - b)[Math.floor(pings.length / 2)],
                    )
                    if (median) {
                        regionPings.value.push({
                            region: region.shortcode,
