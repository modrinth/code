  ...
  >
        ...
        <div class="flex flex-col items-center text-center">
          <div class="flex flex-col items-center gap-4">
            <div class="bg-bg-blue grid place-content-center rounded-full p-4">
              <HammerIcon class="text-blue size-12" />
            </div>
            <h1 class="m-0 w-fit text-3xl font-bold">Servers could not be loaded</h1>
          </div>
          <p class="text-secondary text-lg">We may have temporary issues with our servers.</p>
    ...
    <template v-else>
      <div class="relative flex h-fit w-full flex-col items-center justify-between md:flex-row">
        <h1 class="text-contrast w-full text-4xl font-bold">Servers</h1>
        <div class="mb-4 flex w-full flex-row items-center justify-end gap-2 md:mb-0 md:gap-4">
          <div class="relative w-full text-sm md:w-72">
            ...
            <input
              id="search"
              v-model="searchInput"
              class="border-button-border w-full border pl-9"
              type="search"
              name="search"
              autocomplete="off"
          ...
          <ButtonStyled type="standard">
            <NuxtLink
              class="border-button-border! h-10! border! border-solid! text-sm font-medium! whitespace-pre"
