    ...
    <div class="relative h-full w-full select-none overflow-y-auto">
        ...
        >
            <div class="card flex flex-col gap-4">
                <div class="flex flex-col gap-2">
                    ...
                    <div class="m-0">
                        Edit the Minecraft server properties file. If you're unsure about a specific
                        property, the
                        <NuxtLink
                ...
                <div class="flex flex-col gap-4 rounded-2xl bg-table-alternateRow p-4">
                    <div class="relative w-full text-sm">
                        <label for="search-server-properties" class="sr-only"
                            >Search server properties</label
                        >
                        <SearchIcon
                    ...
                    >
                        ...
                        <div
                            v-else-if="typeof property === 'number'"
                        ...
                        <div
                            v-else-if="isComplexProperty(property)"
                            class="mt-2 w-full sm:w-[320px]"
                        >
                            <textarea
                                :id="`server-property-${index}`"
        ...
        <div v-else class="card flex h-full w-full items-center justify-center">
            <p class="text-contrast">
                The server properties file has not been generated yet. Start up your server to
                generate it.
            </p>
        </div>
...
const hasUnsavedChanges = computed(() => {
    return Object.keys(liveProperties.value).some(
        (key) =>
            JSON.stringify(liveProperties.value[key]) !==
            JSON.stringify(originalProperties.value[key]),
    )
})
