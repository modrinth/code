<template>
    <div class="contents">
        ...
        <div class="relative h-full w-full overflow-y-auto">
            ...
            >
                <div
                    class="flex max-w-lg flex-col items-center rounded-3xl bg-bg-raised p-6 shadow-xl"
                >
                        ...
                        >
                            <label for="user-domain" class="flex flex-col gap-2">
                                <span class="text-lg font-bold text-contrast"
                                    >Generated DNS records</span
                                >
                                <span>
                                    Set up your personal domain to connect to your server via custom
                                    DNS records.
                                </span>
                            </label>
                        ...
                        >
                            ...
                            >
                                <tbody class="w-full">
                                    ...
                                    >
                                        <td
                                            class="w-1/6 py-3 pr-4 md:w-1/5 md:pr-8 lg:w-1/4 lg:pr-12"
                                        >
                                            <div
                                                class="flex flex-col gap-1"
                                                @click="copyText(record.type)"
                                            >
                                                <span
                    ...
                    <div class="card flex flex-col gap-4">
                        ...
                        >
                            <div class="flex flex-col gap-2">
                                ...
                                <span>
                                    Configure additional ports for internet-facing features like map
                                    viewers or voice chat mods.
                                </span>
                            </div>
                        ...
                        <div
                            class="flex w-full flex-col overflow-hidden rounded-xl bg-table-alternateRow p-4"
                        >
                            <!-- Primary allocation -->
                            <div
                        ...
                        >
                            ...
                            >
                                <div class="flex flex-row items-center gap-4">
                                    ...
                                    <div
                                        class="flex w-[20rem] flex-col justify-between sm:flex-row sm:items-center"
                                    >
                                        <div class="flex flex-col gap-1">
                                            <span
                                                class="text-md font-bold tracking-wide text-contrast"
                                            >
                                                {{ allocation.name }}
                                            </span>
                                            <span class="hidden text-xs text-secondary sm:block"
                                                >Name</span
                                            >
                                        </div>
                                        <div class="flex flex-col gap-1">
