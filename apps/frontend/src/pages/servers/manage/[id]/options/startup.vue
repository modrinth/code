                ...
                <div class="card flex flex-col gap-8">
                    <div class="flex flex-col gap-4">
                        <div class="flex flex-col gap-2">
                            ...
                            <span>
                                The version of Java that your server will run on. By default, only
                                the Java versions compatible with this version of Minecraft are
                                shown. Some mods may require a different Java version to work
                                properly.
                            </span>
                        </div>
                        <div class="flex items-center gap-2">
                            <input
                                ...
                                type="checkbox"
                            />
                            <label for="show-all-versions" class="text-sm"
                                >Show all Java versions</label
                            >
                        </div>
...
async function saveStartup() {
    try {
        ...
        await props.server.startup?.update(
            invocationValue,
