<template>
    ...
    <div
        v-else-if="server.general && localMods"
        class="relative isolate flex h-full w-full flex-col"
    >
            ...
            >
                            ...
                            >
                                <template v-for="mod in visibleItems.items" :key="mod.filename">
                                    <div
                                        ...
                                        :class="
                                            mod.disabled
                                                ? 'bg-table-alternateRow text-secondary'
                                                : ''
                                        "
                                        style="height: 64px"
                                    >
                                        ...
                                        >
                                            ...
                                            <div class="flex min-w-0 flex-col gap-1">
                                                <span
                                                    class="text-md flex min-w-0 items-center gap-2 font-bold"
                                                >
                                                ...
                                                <div class="min-w-0 text-xs text-secondary">
                                                    ...
                                                    <span class="block font-semibold sm:hidden">
                                                        {{
                                                            mod.version_number ||
                                                            `External ${type.toLocaleLowerCase()}`
                                                        }}
                                                    </span>
                                                </div>
                                            </div>
                                        ...
                                        <div
                                            class="ml-2 hidden min-w-0 flex-1 flex-col text-sm sm:flex"
                                        >
                ...
                >
                    ...
                    >
                        ...
                        <p class="m-0">
                            Add some {{ type.toLocaleLowerCase() }}s to your server to manage them
                            here.
                        </p>
                ...
                >
                    ...
                    <p class="m-0 pt-3 font-bold text-contrast">
                        Your server is running Vanilla Minecraft
                    </p>
                    <p class="m-0">
                        Add content to your server by installing a modpack or choosing a different
                        platform that supports {{ type }}s.
                    </p>
                    <div class="flex flex-row items-center gap-4">
                        ...
                        <ButtonStyled class="mt-8">
                            <NuxtLink
                                :to="`/servers/manage/${props.server.serverId}/options/loader`"
                            >
                                <WrenchIcon />
                                Change platform
                            </NuxtLink>
