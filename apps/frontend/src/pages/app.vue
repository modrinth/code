    ...
    <div>
        <div class="landing-hero">
            ...
            <h2 class="main-subheader">
                The Modrinth App is a unique, open source launcher that allows you to play your
                favorite mods, and keep them up to date, all in one neat little package.
            </h2>
        ...
        <div class="features">
            ...
            <div class="feature-grid">
                <div class="feature gradient-border mods">
                    ...
                    <p>
                        Modrinth makes it easy to manage all your mods in one place. You can
                        install, uninstall, and update mods with a single click.
                    </p>
                </div>
                <div class="feature gradient-border playing">
                    <div class="text">
                        ...
                        <p>
                            Use the Modrinth App to download and play with your favorite mods and
                            modpacks.
                        </p>
                    </div>
                    <img
                ...
                <div class="feature gradient-border sharing">
                    ...
                    <p>
                        Build, share, and play modpacks with any of the thousands of mods and
                        modpacks hosted here on Modrinth.
                    </p>
                ...
                <div class="feature gradient-border performance">
                    ...
                    <h3>Performant</h3>
                    <p>
                        The Modrinth App performs better than many of the leading mod managers,
                        using just 150mb of RAM!
                    </p>
                </div>
                <div class="feature gradient-border website">
                    ...
                    <p>
                        The Modrinth App is fully integrated with the website, so you can access all
                        your favorite projects from the app!
                    </p>
                </div>
                <div class="feature gradient-border importing">
                    <div class="text">
                        ...
                        <p>
                            Import all your favorite profiles from the launcher you were using
                            before, and get started with the Modrinth App in seconds!
                        </p>
                    </div>
            ...
            <div class="feature-row">
                <div class="point">
                    ...
                    <div class="description">
                        Modrinth’s launcher is fully open source. You can view the source code on
                        our
                        <a href="https://github.com/modrinth/theseus" rel="noopener" target="_blank"
                            >GitHub</a
                        >!
                    </div>
                </div>
