      ...
      <svg v-else viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <defs>
          ...
          >
            ...
            <stop
              offset="0.678759"
              stop-color="color-mix(in srgb, var(--color-brand), black 50%)"
            />
          </linearGradient>
  ...
  .feature-grid {
    ...
    .mods {
      ...
      .search-bar {
        ...
        background: linear-gradient(0deg, #55403b 0%, #55413b 100%), rgba(85, 64, 59, 0.15);
    ...
    .sharing {
      ...
      .export-card {
        ...
        gap: var(--gap-md);
        border-radius: 0;
        background: linear-gradient(0deg, #55413b 0%, #553d3b 100%), rgba(85, 63, 59, 0.15);
        border: 1px solid var(--landing-border-color);
        margin-bottom: 1rem;
        width: 20rem;
        font-size: var(--font-size-sm);
      ...
      .ring-x {
        ...
        .first-ring {
          ...
          background: radial-gradient(
            50% 50% at 50% 50%,
            rgba(206, 35, 5, 0.19) 0%,
            rgba(49, 20, 15, 0.25) 100%
          );
        }
        ...
        .second-ring {
          ...
          background: radial-gradient(
              50% 50% at 50% 50%,
              rgba(206, 42, 5, 0.19) 0%,
              rgba(49, 28, 15, 0.25) 100%
            ),
            radial-gradient(
              50% 50% at 50% 50%,
              rgba(79, 49, 44, 0.25) 0%,
              rgba(50, 36, 32, 0.19) 100%
            );
        }
    ...
    .feature {
      ...
      background: radial-gradient(
        ...
        rgba(50, 36, 32, 0.27) 100%
      );
      box-shadow:
        2px 2px 12px 0px rgba(0, 0, 0, 0.16),
        2px 2px 64px 0px rgba(94, 68, 57, 0.45) inset;
...
.light-mode {
  ...
  .bottom-transition {
    background: linear-gradient(rgba(#f8f7f7, 0) 0%, #f8f7f7 100%);
  }
  ...
  .landing-hero {
    &::before {
      background: url("https://cdn-raw.modrinth.com/app-landing/cube-light.png") no-repeat center
        4rem;
    }
  }
