    ...
    <div class="landing-hero">
      ...
      <div class="flex gap-5">
        <ButtonStyled color="brand" size="large">
          <button v-if="os" rel="noopener nofollow" @click="downloadLauncher">
            <svg
              v-if="os === 'Linux'"
              class="light-icon"
              width="45"
        ...
        <ButtonStyled size="large" type="outlined">
          <button @click="scrollToSection"><DropdownIcon /> More download options</button>
        </ButtonStyled>
      </div>
          ...
          <div class="table">
            ...
            <div class="row">
              <div class="cell">
                <Avatar
                  size="sm"
                  src="https://cdn.modrinth.com/data/mOgUt4GM/1bfe2006b38340e9d064700e41adf84a8abb1bd4_96.webp"
                />
              </div>
              <div class="cell">
            ...
            <div class="row">
              <div class="cell">
                <Avatar
                  size="sm"
                  src="https://cdn.modrinth.com/data/nrJ2NpD0/4f21214db060ed4542b1f3983c4113d293480a1b.webp"
                />
              </div>
              <div class="cell">
