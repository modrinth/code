	...
	<div>
		<div class="landing-hero">
			...
			<h2 class="main-subheader">
				Modrinth App is a unique, open source launcher that allows you to play your favorite mods,
			...
			<div class="feature-grid">
				...
				<div class="feature gradient-border playing">
					<div class="text">
						...
						<p>Use Modrinth App to download and play with your favorite mods and modpacks.</p>
					</div>
					<img
		...
		<div ref="downloadSection" class="footer">
			...
			<div class="section-subheader">
				<div class="section-subheader-title">Download Modrinth App (Beta)</div>
			...
			<div class="download-section">
				...
				<div class="download-card">
					<div class="title">
						...
						<div class="flex">Linux<span class="text-sm text-secondary">*</span></div>
					</div>
					<div class="description apple">
