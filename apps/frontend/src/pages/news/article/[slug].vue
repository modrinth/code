...
<template>
    <div class="page experimental-styles-within py-6">
        ...
        <article class="mt-6 flex flex-col gap-4 px-6">
            ...
            <div
                class="mt-auto flex flex-wrap items-center gap-1 text-sm text-secondary sm:text-base"
            >
                <template v-for="(author, index) in authors" :key="`author-${author.id}`">
                    ...
                    <span class="flex items-center">
                        ...
                        <span v-if="(authors?.length ?? 0) > 2 && index !== authorCount - 1"
                            >,</span
                        >
                    </span>
                </template>
                <template v-if="!authors || authorCount === 0">
                    ...
                    >
                        <Avatar
                            src="https://cdn-raw.modrinth.com/modrinth-icon-96.webp"
                            size="24px"
                        />
                        Modrinth Team
                    </nuxt-link>
