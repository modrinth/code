<template>
  <div class="markdown-body">
    ...
    <p>
      This is the security notice for all BBSMC repositories. The notice explains how
    ...
    <p>
      Send details to <a href="mailto:jai@bbsmc.net">jai@bbsmc.net</a>
      including:
    </p>
    <ul>
...
<script setup>
const description =
  "The Security Notice of BBSMC, an open source modding platform focused on Minecraft.";

useSeoMeta({
  title: "Security Notice - BBSMC",
  description,
