<template>
  <div class="markdown-body">
    ...
    <p>In this scenario, the earnings for each creator and BBSMC would be as follows:</p>
    <ul>
      <li>BBSMC: $25 (25% of $100, the site's earnings for the day)</li>
    ...
    <p>
      ...
      <a href="https://bbsmc.net/dashboard/analytics">analytics dashboard</a>.
    </p>
    ...
    <p>
      No. All creators who upload to BBSMC automatically will receive funds as according to the
    ...
    <p>
      BBSMC receives ad revenue from our ad providers on a NET 60 day basis. Due to this, not all
    ...
    <h3>How do I know BBSMC is being transparent about revenue?</h3>
    <p>
...
<script setup>
const description =
  "Information about the Rewards Program of BBSMC, an open source modding platform focused on Minecraft.";

useSeoMeta({
  title: "Rewards Program Information - BBSMC",
  description,
