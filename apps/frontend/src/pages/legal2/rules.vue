<template>
  <div class="markdown-body">
    ...
    <p>
      ...
      <nuxt-link to="/legal2/terms">Terms of Use</nuxt-link> and apply to any and all User
    ...
    <ol>
      ...
      <li>
        ...
        <nuxt-link to="/legal2/terms">Terms of Use</nuxt-link> or
        <nuxt-link to="/legal2/privacy">Privacy Policy</nuxt-link>.
      </li>
      <li>
