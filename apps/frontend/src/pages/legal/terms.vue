<template>
    <div class="markdown-body">
        ...
        <p>
            ...
            (<strong>"Company"</strong>, <strong>"we"</strong> or <strong>"us"</strong>). The
            ...
            www.modrinth.com, api.modrinth.com, or the Modrinth App, including any content,
            functionality and services offered on or through www.modrinth.com, api.modrinth.com, or
            the Modrinth App (the "Service"), whether as a guest or a registered user.
        </p>
        <p>
            Please read the Terms of Use carefully before you start to use the Service. By accessing
            or using the Service, you accept and agree to be bound and abide by these Terms of Use,
            our Privacy Policy, our Copyright Policy, and our California Privacy Notice. If you do
            not want to agree to these terms and policies, you must not access or use the Service.
        </p>
        <p>
            The Service is offered and available to users who are 13 years of age or older. By using
            the Service, you represent and warrant that you are of legal age to form a binding
            contract with the Company and meet all of the foregoing eligibility requirements. If you
            do not meet all of these requirements, you must not access or use the Service.
        </p>
        ...
        <p>
            Your continued use of the Service following the posting of revised Terms of Use means
            that you accept and agree to the changes. You are expected to check this page each time
            you access the Service so you are aware of any changes, as they are binding on you.
        </p>
        <h2>Accessing the Service and Account Security</h2>
        <p>
            We reserve the right to withdraw or amend the Service, and any service or material we
            provide through the Service, in our sole discretion without notice. We will not be
            liable if for any reason all or any part of the Service is unavailable at any time or
            for any period. From time to time, we may restrict access to some parts of the Service,
        ...
        <p>
            ...
            Service, and ensuring that all persons who access the Service through your internet
            connection are aware of these Terms of Use and comply with them.
        </p>
        <p>
            To access the Service or some of the resources it offers, you may be asked to provide
            certain registration details or other information. It is a condition of your use of the
            Service that all the information you provide on the Service is correct, current and
            complete. You agree that all information you provide to register with the Service or
            otherwise, including but not limited to through the use of any interactive features on
            the Service, is governed by our Privacy Policy, and you consent to all actions we take
            with respect to your information consistent with our Privacy Policy.
        </p>
        <p>
            If you choose, or are provided with, a email, password or any other piece of information
            as part of our security procedures, you must treat such information as confidential, and
            you must not disclose it to any other person or entity. You also acknowledge that your
            account is personal to you and agree not to provide any other person with access to the
            Service or portions of it using your user name, password or other security information
            (and if you do, you agree to be responsible for and to indemnify, defend and hold us
            harmless from any damages caused by any such person to whom you provide any such
            information). You agree to notify us immediately of any unauthorized access to or use of
            your user name or password or any other breach of security. You should use particular
            caution when accessing your account from a public or shared computer so that others are
        ...
        <p>
            The Service allows you to upload and share your gaming content (the "Gaming Content", to
            be distinguished from User Contributions, defined below) with other users of our
            Service. Unlike User Contributions, which are owned by the Company, when you use the
            Service and upload and share your Gaming Content, the Company does not claim any right,
            title or interest in or to your Gaming Content. At the same time, the Company disclaims
            any and all liability in connection with the Gaming Content, and you are solely
            responsible for any and all claims, actions, damages and the like in connection with the
            Gaming Content.
        </p>
        <p>
            When you upload your Gaming Content, you hereby grant us a limited use, non-exclusive,
            royalty-free, fully paid up, right to display and distribute your Gaming Content to our
            users through the Service, which our users in turn may then use at their sole
            discretion.
        </p>
        <p>
            When you delete your Gaming Content, you agree that your Gaming Content may continue to
            be used by any users who have previously downloaded your Gaming Content pursuant to the
            preceding license, and you also agree that your Gaming Content may continue to be part
            of any already-existing Gaming Content "packs" created by other users as part of our
            Service until such time as such Gaming Content has been deleted by such user(s) as part
            of such "pack(s)". Otherwise, for the avoidance of doubt, as between the Company and
            you, you own and will continue to own all right, title and interest in and to your
            Gaming Content.
        </p>
        <p>
        ...
        <p>
            ...
            (Modrinth API). The Modrinth API enables users to perform actions on the Service via
            their own services, such as their websites and/or applications.
        </p>
        <p>
            We grant the User of the Modrinth API a limited, non-exclusive, non-sublicensable and
            revocable license to download, display, query, create, edit, and delete the User
            Generated Content on the Service via their own services, such as their websites and/or
            applications (the API License), provided the User complies with the following
            conditions:
        </p>
        <ul>
            <li>
                The User uses the Modrinth API in accordance with these Terms, the Community
                Standards and all applicable laws and regulations that apply to such use.
            </li>
            <li>the User does not infringe any rights of third parties.</li>
            <li>
                the User provides Modrinth all assistance requested in complying with, and
                concluding all agreements required by the applicable laws and regulations.
            </li>
        </ul>
        <p>
            Each User using the Modrinth API shall indemnify Modrinth and keep Modrinth indemnified
            for all claims, proceedings or actions brought by another User or any other third party,
        ...
        <p>
            The Company pays to you a percentage of net revenue collected by us and attributable to
            ad impressions displayed solely on your project pages. The funds are directly deposited
            into your account, which you can monitor and access via your creator dashboard. Simply
            enroll in the Rewards Program on your dashboard in order to be able to take advantage of
            this program. Please review the
            <nuxt-link to="/legal/cmp">Rewards Program Terms</nuxt-link>, as it contains very
            important language regarding, among other things, your status as an independent
            contractor, your responsibility to pay taxes, our disclaimers and limitations of
            liability (in addition to our disclaimers and limitations of liability in these Terms of
            Use).
        </p>
        <h2>Intellectual Property Rights</h2>
        <p>
            Except for the Gaming Content, the Service and its entire contents, features and
            functionality (including but not limited to all information, software, text, displays,
            images, video and audio, and the design, selection and arrangement thereof), are owned
            by the Company, its licensors or other providers of such material and are protected by
            United States and international copyright, trademark, patent, trade secret and other
            intellectual property or proprietary rights laws.
        </p>
        <p>
            These Terms of Use permit you to use the Service for your personal, non-commercial use
            only.
        </p>
        <p>
            ...
            Any use of the Service not expressly permitted by these Terms of Use is a breach of
            these Terms of Use and may violate copyright, trademark and other laws.
        </p>
        <h2>Trademarks</h2>
        <p>
            The Company name, the terms Modrinth, the Company logo and all related names, logos,
            product and service names, designs and slogans are trademarks of the Company or its
            ...
            and slogans contained in the Service are the trademarks of their respective owners.
        </p>
        <h2>Prohibited Uses</h2>
        <p>
            You may use the Service only for lawful purposes and in accordance with these Terms of
            Use. You agree not to use the Service:
        </p>
        <ul>
            <li>
            ...
            <li>
                ...
                not comply with the <nuxt-link to="/legal/rules">Content Rules</nuxt-link>.
            </li>
            <li>
        ...
        <ul>
            <li>
                ...
                site or interfere with any other party's use of the Service, including their ability
            ...
            <li>
                Use any manual process to monitor or copy any of the material contained in the
        ...
        <p>
            The Service may contain message boards, chat rooms, personal web pages or profiles,
            forums, bulletin boards and other interactive features (collectively,
            <strong>"Interactive Services"</strong>) that allow users to post, submit, publish,
            display or transmit to other users or other persons (hereinafter,
            <strong>"post"</strong>) content (other than Gaming Content, as defined above) or
            materials (collectively, <strong>"User Contributions"</strong>) on or through the
            Service.
        </p>
        <p>
        ...
        <p>
            ...
            non-proprietary. By providing any User Contribution through the Service, you grant us
            ...
            consistent with your account settings.
        </p>
        ...
        <ul>
            ...
            <li>
                ...
                Contribution violates the Terms of Use, including the Content Rules, infringes any
                intellectual property right or other right of any person or entity, threatens the
                personal safety of users of the Service or the public or could create liability for
                the Company.
            </li>
            <li>
        ...
        <p>
            ...
            identity or other information of anyone posting any materials on or through the Service.
        ...
        <p>
            However, we cannot ensure prompt removal of objectionable material after it has been
        ...
        <p>
            ...
            Copyright Policy for instructions on sending us a notice of copyright infringement. It
        ...
        <p>
            ...
            materials by you or any other visitor to the Service, or by anyone who may be informed
            of any of its contents.
        </p>
        <p>
            The Service includes content provided by third parties, including materials provided by
        ...
        <p>
            We may update the content on the Service from time to time, but its content is not
            necessarily complete or up-to-date. Any of the material on the Service may be out of
        ...
        <p>
            You may link to our website, provided you do so in a way that is fair and legal and does
        ...
        <ul>
            ...
            <li>
                ...
                content, contained in the Service.
            </li>
            <li>
                Cause limited portions of content contained in the Service to be displayed or appear
        ...
        <p>
            ...
            terms and conditions we provide with respect to such features. Subject to the foregoing,
            you must not:
        </p>
        <ul>
            <li>
                Cause the Service or portions of it to be displayed, or appear to be displayed by,
                for example, framing, deep linking or in-line linking, on any other site.
            </li>
            <li>
                Otherwise take any action with respect to the materials contained in the Service
        ...
        <p>
            If the Service contains links to other sites and resources provided by third parties,
            ...
            of the third party websites linked to this Service, you do so entirely at your own risk
            and subject to the terms and conditions of use for such websites.
        </p>
        <h2>Geographic Restrictions</h2>
        <p>
            The owner of the Service is based in the state of Delaware in the United States. Access
            to the Service may not be legal by certain persons or in certain countries. If you
            access the Service from outside the United States, you do so on your own initiative and
        ...
        <p>
            ...
            downloading from the internet or the Service will be free of viruses or other
            ...
            PROPRIETARY MATERIAL DUE TO YOUR USE OF THE SERVICE OR ANY SERVICES OR ITEMS OBTAINED
            THROUGH THE SERVICE OR TO YOUR DOWNLOADING OF ANY MATERIAL POSTED ON IT, OR ON ANY
            WEBSITE LINKED TO IT.
        </p>
        <p>
            YOUR USE OF THE SERVICE, ITS CONTENT AND ANY SERVICES OR ITEMS OBTAINED THROUGH THE
            SERVICE IS AT YOUR OWN RISK. THE SERVICE, ITS CONTENT AND ANY SERVICES OR ITEMS OBTAINED
            THROUGH THE SERVICE ARE PROVIDED ON AN "AS IS" AND "AS AVAILABLE" BASIS, WITHOUT ANY
            ...
            COMPLETENESS, SECURITY, RELIABILITY, QUALITY, ACCURACY OR AVAILABILITY OF THE SERVICE.
            WITHOUT LIMITING THE FOREGOING, NEITHER THE COMPANY NOR ANYONE ASSOCIATED WITH THE
            COMPANY REPRESENTS OR WARRANTS THAT THE SERVICE, ITS CONTENT OR ANY SERVICES OR ITEMS
            OBTAINED THROUGH THE SERVICE WILL BE ACCURATE, RELIABLE, ERROR-FREE OR UNINTERRUPTED,
            THAT DEFECTS WILL BE CORRECTED, THAT THE SERVICE OR THE SERVER THAT MAKES IT AVAILABLE
            ARE FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS OR THAT THE SERVICE OR ANY SERVICES OR
            ITEMS OBTAINED THROUGH THE SERVICE WILL OTHERWISE MEET YOUR NEEDS OR EXPECTATIONS.
        </p>
        <p>
        ...
        <p>
            ...
            SERVICE, ANY WEBSITES LINKED TO IT, ANY CONTENT ON THE SERVICE OR SUCH OTHER WEBSITES OR
            ANY SERVICES OR ITEMS OBTAINED THROUGH THE SERVICE OR SUCH OTHER WEBSITES, INCLUDING ANY
        ...
        <p>
            IN NO EVENT WILL THE COMPANY, ITS AFFILIATES OR THEIR LICENSORS, SERVICE PROVIDERS,
            EMPLOYEES, AGENTS, OFFICERS OR DIRECTORS BE LIABLE FOR DAMAGES OF ANY KIND, UNDER ANY
            LEGAL THEORY WHATSOEVER, FOR DAMAGES TO YOU AND/OR ANY OTHER PARTY WHATSOEVER (TAKEN IN
            THE AGGREGATE) IN EXCESS OF THE AMOUNTS RECEIVED FROM YOU DURING THE THREE (3) MONTH
            PERIOD PRIOR TO THE EVENT GIVING RISE TO THE CLAIM.
        </p>
        <p>
        ...
        <p>
            ...
            (including reasonable attorneys' fees and court costs) arising out of or relating to
            your violation of these Terms of Use or your use of the Services, including, but not
        ...
        <p>
            All matters relating to the Service and these Terms of Use and any dispute or claim
            ...
            or rule (whether of the State of Delaware or any other jurisdiction). Any legal suit,
            action or proceeding arising out of, or related to, these Terms of Use or the Service
            shall be instituted exclusively in the federal courts of the United States or the courts
            of the State of Delaware in each case located in Delaware, although we retain the right
            to bring any suit, action or proceeding against you for breach of these Terms of Use in
            your country of residence or any other relevant country. You irrevocably waive any and
        ...
        <p>
            ...
            the use of these Terms of Use or the Service, including disputes arising from or
        ...
        <p>
            ...
            provision. If any provision of these Terms of Use is held by a court or other tribunal
        ...
        <p>
            ...
            <strong>California Privacy Notice</strong> (if applicable) constitute the sole and
            entire agreement between you and the Company with respect to the Service and supersede
        ...
        <p>
            ...
            designated in our Copyright Policy in the manner and by the means set forth therein.
        </p>
        <p>
            All other feedback, comments, requests for technical support and other communications
            relating to the Service should be directed to:
