<template>
    <div class="markdown-body">
        ...
        <p>
            ...
            "we," "us" or "our") and applies solely to all visitors, users, and others who reside in
            the State of California ("consumers" or "you"). We adopt this notice to comply with the
            California Consumer Privacy Act of 2018 (CCPA), as it may be amended, modified or
            supplemented from time to time, and any terms defined in the CCPA have the same meaning
        ...
        <p>
            ...
            with a particular consumer or device (<strong>"personal information"</strong>). In
            particular, our Service has collected the following categories of personal information
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        or health insurance information. <br /><br />
        ...
        <ul>
            ...
            <li>
                To personalize your Service experience and to deliver content and product and
                service offerings relevant to your interests, including targeted offers and ads
                through our Service, third-party sites, and via email or text message (with your
                consent, where required by law).
            </li>
            <li>
                To help maintain the safety, security, and integrity of our Service, products and
            ...
            <li>
                ...
                dissolution, or other sale or transfer of some or all of the Company's assets,
                whether as a going concern or as part of bankruptcy, liquidation, or similar
                proceeding, in which personal information held by the Company about our Service
        ...
        <p>
            ...
            confidential and not use it for any purpose except performing the contract. The CCPA
            prohibits third parties who purchase the personal information we hold from reselling it
        ...
        <p>
            ...
            and confirm your verifiable consumer request (see
            <i>Exercising Access, Data Portability, and Deletion Rights</i>), we will disclose to
            you:
        </p>
        <ul>
        ...
        <p>
            ...
            confirm your verifiable consumer request (see
            <i>Exercising Access, Data Portability, and Deletion Rights</i>), we will delete (and
        ...
        <p>
            ...
            submit a verifiable consumer request to us by emailing us at
        ...
        <p>
            ...
            However, we do consider requests made through your password protected account
            sufficiently verified when the request relates to personal information associated with
        ...
        <p>
            ...
            in different prices, rates, or quality levels. Any CCPA-permitted financial incentive we
            offer will reasonably relate to your personal information's value and contain written
            terms that describe the program's material aspects. Participation in a financial
        ...
        <p>
            ...
            When we make changes to this privacy notice, we will post the updated notice on the
            Service and update the notice's effective date.
            <strong
        ...
        <p>
            ...
            and use your information described below and in the
            <nuxt-link to="/legal/privacy">Privacy Policy</nuxt-link>, your choices and rights
