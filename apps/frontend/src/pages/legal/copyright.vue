<template>
    <div class="markdown-body">
        ...
        <p>
            ...
            alleged copyright infringement that comply with applicable law. If you believe any
            materials accessible on or from this site (the <strong>"Website"</strong>) infringe your
            copyright, you may request removal of those materials (or access to them) from the
            Website by submitting written notification to our copyright agent designated below. In
            accordance with the Online Copyright Infringement Liability Limitation Act of the
            Digital Millennium Copyright Act (17 U.S.C. § 512) (<strong>"DMCA"</strong>), the
            written notice (the <strong>"DMCA Notice"</strong>) must include substantially the
            following:
        </p>
        <ul>
            ...
            <li>
                A statement that you have a good faith belief that use of the copyrighted material
        ...
        <p>
            ...
            <strong>"Counter Notice"</strong>) by submitting written notification to our copyright
            agent designated above. Pursuant to the DMCA, the Counter Notice must include
        ...
        <p>
            Please be aware that if you knowingly materially misrepresent that material or activity
            on the Website was removed or disabled by mistake or misidentification, you may be held
            liable for damages (including costs and attorneys' fees) under Section 512(f) of the
            DMCA.
        </p>
