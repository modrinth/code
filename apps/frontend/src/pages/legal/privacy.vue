<template>
    <div class="markdown-body">
        ...
        <h2>Introduction</h2>
        <p>
            <a href="https://modrinth.com">Modrinth</a> is part of Rinth, Inc. ("Company", "us",
            "we", "our"). This privacy policy explains how we collect data, process it, and your
            rights relative to your data.
        </p>
        <p>
            This policy describes the types of information we may collect from you or that you may
            provide when you use www.modrinth.com, api.modrinth.com, or the Modrinth App ("Service"
            or "Website"), and our practices for collecting, using, maintaining, protecting, and
        ...
        <ul>
            <li>
                ...
                Rinth, Inc. or any third party (including our affiliates and subsidiaries); or
            </li>
            <li>
        ...
        <p>
            ...
            you agree to this privacy policy. This policy may change from time to time (see Changes
            to the Privacy Policy). Your continued use of this Website after we make changes is
        ...
        <p>
            The following document was created as required by several laws, including but not
            limited to:
        </p>
        <ul>
            <li>
                the California Consumer Privacy Act (CA CCPA), more information about which can be
                found on
                <a href="https://oag.ca.gov/privacy/ccpa">oag.ca.gov</a>
            </li>
            <li>
                the European Union General Data Protection Regulation (EU GDPR), more information
                about which can be found on
        ...
        <ul>
            ...
            <li>
                Some additional metadata about the projects you're playing (loaders and game
                versions)
            </li>
        </ul>
        ...
        <p>
            We use some third-party services to make Modrinth run. Please refer to each of their
        ...
        <p>
            Data that we specifically collect isn't shared with any other third party. We do not
            sell any data.
        </p>

        <h2>Data Governance</h2>
        <p>
            Database access is limited to the minimum amount of Rinth, Inc. employees required to
            run the service.<br />
            Data is stored in a jurisdiction that is part of the European Economic Area (EEA),
        ...
        <p>
            ...
            identity before proceeding and will respond to your request within 30 days as required
            by law, or notify you of an extended reply time.
        </p>
        ...
        <p>
            Modrinth does not knowingly collect any Personal Identifiable Information from children
        ...
        <p>
            ...
            our website with regards to the information that they shared and/or collect in Modrinth.
        ...
        <p>
            ...
            privacy rights, visit <nuxt-link to="/legal/ccpa">this page</nuxt-link>.
        </p>
        <p>
            California's "Shine the Light" law (Civil Code Section § 1798.83) permits users of our
            App that are California residents to request certain information regarding our
        ...
        <p>
            ...
            If we do this, we will post the changes on this page and update the "Last edited" date
            at the top of this page, after which such changes will become effective immediately. We
            will make an effort to keep users updated on any such changes, but because most changes
            do not affect how we process existing data, a notice will not be sent for all changes.
        </p>

        <h2>Contact</h2>
        <p>
            If you have any questions about this privacy policy or how we process your data, contact
            us at
        ...
        <p>
            Should you wish to fill a complaint or if you feel like we haven't addressed your
            concerns or request, you may contact the
