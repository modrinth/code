<template>
    <div class="markdown-body">
        ...
        <p>
            If you've found a vulnerability, we would like to know so we can fix it before it is
            released publicly.
        ...
        <ul>
            ...
            <li>
                reports indicating that our services do not fully align with "best practice", for
