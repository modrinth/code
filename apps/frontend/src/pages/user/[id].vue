            ...
            <div class="flex flex-col gap-3">
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <span>
                        ...
                        <template
                            v-if="
                                user.payout_data?.paypal_address && user.payout_data?.venmo_address
                            "
                        >
                            ,
                        </template>
        ...
        <div class="new-page sidebar" :class="{ 'alt-layout': cosmetics.leftContentLayout }">
            ...
            <div class="normal-page__content">
                ...
                >
                        ...
                        <IntlFormatted :message-id="messages.profileNoCollectionsAuthLabel">
                            <template #create-link="{ children }">
                                <a
                                    class="link"
                                    @click.prevent="
                                        (event) => $refs.modal_collection_creation.show(event)
                                    "
                                >
                                    <component :is="() => children" />
                                </a>
                    ...
                    <span v-else class="text">{{
                        formatMessage(messages.profileNoCollectionsLabel)
                    }}</span>
                </div>
            </div>
