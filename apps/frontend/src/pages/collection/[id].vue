                        ...
                        <div class="inputs universal-labels">
                            ...
                            <DropdownSelect
                                ...
                                :display-name="
                                    (s) => {
                                        if (s === 'listed')
                                            return formatMessage(commonMessages.publicLabel)
            ...
            <div class="normal-page__content">
                <nav class="navigation-card">
                    ...
                    <button
                        v-tooltip="
                            formatMessage(
                                commonMessages[
                                    `${cosmetics.searchDisplayMode.collection || 'list'}InputView`
                                ],
                            )
                        "
                        :aria-label="
                    ...
                    >
                        ...
                        <ImageIcon
                            v-else-if="cosmetics.searchDisplayMode.collection === 'gallery'"
                        />
                        <ListIcon v-else />
                    </button>
                </nav>
                ...
                <div
                    ...
                    :class="
                        ...
                        (cosmetics.searchDisplayMode.collection || 'list')
                    "
                >
                    <ProjectCard
