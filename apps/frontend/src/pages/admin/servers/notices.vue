<template>
    ...
    <div class="page experimental-styles-within">
        ...
        <div>
            ...
            >
                <div
                    class="col-span-full grid grid-cols-subgrid gap-4 px-4 font-bold text-contrast"
                >
                ...
                >
                    <div class="col-span-full grid grid-cols-subgrid items-center gap-4">
                        ...
                        <div
                            :style="{
                                '--_color': notice.dismissable
                                    ? 'var(--color-green)'
                                    : 'var(--color-red)',
                                '--_bg-color': notice.dismissable
                                    ? 'var(--color-green-bg)'
                                    : 'var(--color-red-bg)',
                            }"
                        >
