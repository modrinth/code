	...
	<div class="mb-16 flex flex-col gap-8 p-12 py-0">
		<div class="flex flex-col gap-5">
			...
			<div class="flex flex-col">
				<div class="flex flex-row justify-between border-0 !border-b-[2px] border-solid border-button-bg p-2">
					<span class="text-md my-auto flex flex-row items-center gap-2 leading-none"><span
							class="gradient-border my-auto block size-4 rounded-full bg-brand-green"></span>
						{{ formatMessage(messages.availableNow) }}</span>
					<span class="text-lg font-semibold text-contrast" :class="{ '!text-green': hoveredSeg === 'available' }">{{
				...
				<div v-for="(date, i) in dateSegments" :key="date.date"
					...
					<span class="text-md my-auto flex flex-row items-center gap-2 leading-none">
						...
						<Tooltip theme="dismissable-prompt" :triggers="['hover', 'focus']" no-auto-focus>
							<nuxt-link class="inline-flex items-center justify-center text-link" to="/legal/cmp-info#pending">
				...
				<div class="flex flex-row justify-between p-2">
					<span class="text-md my-auto flex flex-row items-center gap-2 leading-none">
						<span
							class="zone--striped-small zone--striped--gray my-auto block size-4 rounded-full bg-button-bg opacity-90"></span>
					...
					<span class="text-lg font-semibold text-contrast" :class="{ '!text-gray': hoveredSeg === 'processing' }">{{
				...
				<button
					...
					<svg aria-hidden="true" class="pointer-events-none absolute bottom-0 right-0 z-0 h-full w-auto"
						...
						<path
							...
							stroke="#1BD96A" stroke-opacity="0.12" />
						<path
