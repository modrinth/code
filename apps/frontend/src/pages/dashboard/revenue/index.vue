    ...
    <div class="experimental-styles-within">
        <section class="universal-card">
                ...
                <div class="grid-display__item">
                    ...
                    <ul class="m-0 list-none p-0">
                        ...
                        >
                            <span
                                v-tooltip="
                                    availableSoonDateKeys.indexOf(date) ===
                                    availableSoonDateKeys.length - 1
            ...
            <p class="text-sm text-secondary">
                By uploading projects to Modrinth and withdrawing money from your account, you agree
                to the
                <nuxt-link class="text-link" to="/legal/cmp">Rewards Program Terms</nuxt-link>. For
                more information on how the rewards system works, see our information page
        ...
        <section class="universal-card">
            ...
            <template v-if="auth.user.auth_providers.includes('paypal')">
                <p>
                    Your PayPal {{ auth.user.payout_data.paypal_country }} account is currently
            ...
            <h3>Tremendous</h3>
            <p>
                Tremendous payments are sent to your Modrinth email. To change/set your Modrinth
                email, visit
...
const availableSoonDates = computed(() => {
    ...
    const dates = Object.keys(userBalance.value.dates)
        .filter((date) => {
            ...
            return (
                dateObj.isAfter(dayjs()) &&
                dateObj.isBefore(dayjs(deadlineEnding.value).add(4, 'month'))
            )
        })
