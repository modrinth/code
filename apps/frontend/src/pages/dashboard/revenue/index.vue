	...
	<div>
		<section class="universal-card">
			<div class="flex flex-col gap-4 md:gap-5">
				...
				<div
					class="flex h-3 w-full gap-2 overflow-hidden rounded-full md:h-4"
					:class="segments.length > 0 ? 'bg-bg-raised' : 'bg-divider'"
				>
					<div
				...
				<div class="flex flex-col">
					...
					>
						<span
							class="my-auto flex flex-row items-center gap-2 text-sm leading-none md:text-base"
						>
							<span
