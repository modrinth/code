<template>
    <div>
            ...
            <div class="universal-modal">
                ...
                <template v-else>
                    <template v-if="twoFactorStep === 0">
                        <p>
                            Two-factor authentication keeps your account secure by requiring access
                            to a second device in order to sign in.
                            <br /><br />
                    ...
                    <template v-if="twoFactorStep === 2">
                        <p>
                            Download and save these back-up codes in a safe place. You can use these
                            in-place of a 2FA code if you ever lose access to your device! You
                            should protect these codes like your password.
                        </p>
                    ...
                    <div class="input-group push-right">
                        ...
                        <button
                            ...
                            class="iconified-button brand-button"
                            @click="
                                twoFactorStep === 1 ? verifyTwoFactorCode() : (twoFactorStep = 1)
                            "
                        >
                            <RightArrowIcon />
                            Continue
        ...
        <section class="universal-card">
            ...
            <div class="adjacent-input">
                <label for="theme-selector">
                    ...
                    <span class="label__description">
                        Add or remove sign-on methods from your account, including GitHub, GitLab,
                        Microsoft, Discord, Steam, and Google.
                    </span>
                </label>
                <div>
        ...
        <section id="data-export" class="universal-card">
            <h2>Data export</h2>
            <p>
                Request a copy of all your personal data you have uploaded to Modrinth. This may
        ...
        <section id="delete-account" class="universal-card">
            ...
            <p>
                ...
                remove all attached data, excluding projects, from our servers.
            </p>
            <button
                type="button"
                class="iconified-button danger-button"
