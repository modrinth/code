<template>
    <div class="universal-card">
        ...
        <p>
            When you authorize an application with your Modrinth account, you grant it access to
            your account. You can manage and review access to your account here at any time.
        </p>
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <nuxt-link
                                    ...
                                    >{{ authorization.owner.username }}</nuxt-link
                                >
