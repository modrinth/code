/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ae337b359d97518b1d619b68a1555db3)
// Runtime types generated with workerd@1.20260722.1 2026-08-05 nodejs_compat_v2
interface __BaseEnv_Env {
	RATE_LIMIT_IGNORE_KEY: SecretsStoreSecret;
	ASSETS: Fetcher;
	ENVIRONMENT: "staging" | "production";
	SENTRY_ENVIRONMENT: "staging" | "production";
	STRIPE_PUBLISHABLE_KEY: "pk_test_51JbFxJJygY5LJFfKV50mnXzz3YLvBVe2Gd1jn7ljWAkaBlRz3VQdxN9mXcPSrFbSqxwAb0svte9yhnsmm7qHfcWn00R611Ce7b" | "pk_live_51JbFxJJygY5LJFfKLVVldb10HlLt24p421OWRsTOWc5sXYFOnFUXWieSc6HD3PHo25ktx8db1WcHr36XGFvZFVUz00V9ixrCs5";
	BASE_URL: string;
	BROWSER_BASE_URL: string;
	PYRO_BASE_URL: string;
	SHARED_INSTANCES_API_BASE_URL: string;
	PROD_OVERRIDE: string;
	INTERCOM_IDENTITY_SECRET?: SecretsStoreSecret;
