...
![Lines of Code](https://img.shields.io/badge/lines_of_code-~785K-purple?style=for-the-badge&color=c78aff)
...
Welcome to the Modrinth Monorepo, the primary codebase for the Modrinth web interface and app. It contains ~785K lines of code and has ![Contributors](https://img.shields.io/github/contributors/Modrinth/code?color=black&label=) contributors!
