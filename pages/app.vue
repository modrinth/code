...
<template>
  <div>
    <div class="landing-hero">
      ...
      <img src="https://i.imgur.com/n6pheS4.png" alt="cube maze" />
    ...
    <div class="features">
      ...
      <div class="feature-grid">
        <div class="feature gradient-border mods">
          ...
          <div class="table">
            <div class="row first">
              ...
              <div class="cell important">1.0.0</div>
            ...
            <div class="row">
              ...
              <div class="cell">69.420.8008135</div>
              <div class="cell check">
                <Checkbox :model-value="true" />
                <button class="btn icon-only transparent">
                  <TrashIcon />
        ...
        <div class="feature gradient-border playing">
          ...
          <img
            src="https://i.imgur.com/KCCpd0k.png"
            alt="Modrinth app playing Cobblemon for Fabric"
            class="launcher"
          />
          <img
            src="https://i.imgur.com/rD2Ve5d.png"
        ...
        <div class="feature gradient-border website">
          ...
          <p>
            Modrinth app is fully integrated with the website, so you can access all your favorite
        ...
        <div class="feature gradient-border importing">
          <div class="text">
            ...
            <p>
              ...
              started with Modrinth app in seconds!
            </p>
          </div>
      ...
      <div class="feature-row">
        <div class="point">
          ...
          <div class="description">
            Modrinth’s launcher is fully open source. You can view the source code here!
          </div>
        </div>
        <div class="point">
          <div class="title">
...
.light-mode {
  ...
  .landing-hero {
    background: url('https://i.imgur.com/xyVeEi6.png') no-repeat top;
  }
