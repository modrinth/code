 ...
 * Owyx wordmark · one value line · status+IP · one primary CTA + secondary auth.
 */
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-12 pb-16 sm:pt-16 sm:pb-20">
        <div className="max-w-2xl min-w-0">
          ...
          <p className="fade-up-2 mt-5 text-base sm:text-lg text-muted max-w-xl leading-relaxed">
            Свой лаунчер Minecraft: скачал, ввёл ник — играешь. Аккаунт Owyx — для
            скина и плюшек.
          </p>

          <div className="fade-up-2 mt-5 flex flex-wrap items-center gap-3">
            <ServerStatus />
            <CopyIPButton ip={ip} />
          </div>
